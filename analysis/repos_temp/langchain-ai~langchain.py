...
Last line of conversation:
Human: {input}
Updated summary:""""""You are a planner that plans a sequence of API calls to assist with user queries against an API.
...
Always use double quotes for strings in the json string.""""""Use this when you want to PUT to a website.
Input to the tool should be a json string with 3 keys: "url", "data", and "output_instructions".
The value of "url" should be a string.
...
ONLY USE THIS TOOL IF THE USER HAS SPECIFICALLY REQUESTED TO DELETE SOMETHING.""""""Use the following portion of a long document to see if any of the text is relevant to answer the question. 
