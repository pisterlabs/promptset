...
paragraph_file = "./data/mgkg_data/paragraph_pubmed_0720_retry.txt"
result_write_file = "./results/mgkg_result/paragraph_pubmed_0720_retry_result_reverse.json"
result_single_write_file = "./results/mgkg_result/paragraph_pubmed_0720_retry_result_single_reverse.json"
retry_write_file = "./data/mgkg_data/paragraph_pubmed_0720_retry_retry_reverse.txt"
with open(paragraph_file, "r") as file:
    paragraphs = file.readlines()
paragraphs = paragraphs[len(paragraphs)//2: ]   # 只处理后半部分paragraph
paragraphs.reverse()    # 将paragraphs倒序，从后往前处理
