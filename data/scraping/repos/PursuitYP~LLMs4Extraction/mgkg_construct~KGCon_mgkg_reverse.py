...
result_write_file = "./results/mgkg_result/paragraph_pubmed_0720_result_reverse.json"
result_single_write_file = "./results/mgkg_result/paragraph_pubmed_0720_result_single_reverse.json"
retry_write_file = "./data/mgkg_data/paragraph_pubmed_0720_retry_reverse.txt"
...
with open(result_single_write_file, "w", newline='\n') as wrt_single_file:
    for paragraph in tqdm(paragraphs, total=len(paragraphs), desc='Processing paragraphs (reverse)'):
