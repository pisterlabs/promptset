...
Ported over from FastChat/fastchat/llm_judge/common.py
"""
...
from fastchat.model.model_adapter import get_conversation_template # THIS NEEDS TO BE REMOVED
...
def run_judge_single(question, answer, judge, ref_answer, multi_turn=False):
    ...
    conv = get_conversation_template(model) # NEED TO ADDRESS THIS LINE (and below)
