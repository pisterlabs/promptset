...
def chat_completion_with_backoff(prompt, **kwargs):
    ...
    raw_response = openai.ChatCompletion.create(
        ...
        messages=[
            ...
            },  # "You are a helpful assistant."},#"You are a helpful assistant with an excellent understanding of the physical world."},
...
Answer (respond with only a number between 1 and 7 inclusive, with 1 being "not at all" and 7 being "very well"):"""
            ...
            popped_option=option_nums.pop()
            total_points[popped_option]=sum_int_avg #uncompromised

            total_points_stds[popped_option]=sum_int_std
