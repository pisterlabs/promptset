...
from openai_ros.robot_envs import firefly_env_yawrate
...
class DeepFollowEnv(firefly_env_yawrate.FireflyEnv):
    ...
    #               'actor::RightHand', 'actor::RightFingerBase', 'actor::RightHandIndex1', 'actor::RThumb'
        ...
        if self.ACTION_TYPE=="discrete":
            ...
            self.action_space = spaces.Box(np.array([self.control_z_min]),np.array([self.control_z_max])) #yawrate control
