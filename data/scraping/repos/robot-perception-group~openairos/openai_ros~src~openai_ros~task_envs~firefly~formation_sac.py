...
from openai_ros.robot_envs import firefly_env, firefly_sac_env
...
class DeepFollowEnv(firefly_sac_env.FireflySACEnv):
    ...
    def _compute_reward(self, observations, done):
        ...
        if not done:
            ...
            # else:
            #     reward += 0.01*self.detection.data
            reward += (1-np.tanh(0.1*error))+0.1*self.detection.data
