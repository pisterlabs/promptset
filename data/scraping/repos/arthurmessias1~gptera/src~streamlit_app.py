...
st.markdown("<h1 style='text-align: center;'>Chat-GPTera</h1>", unsafe_allow_html=True)
...
if "total_cost" not in st.session_state:
    st.session_state["total_cost"] = 0.0  # Or whatever initial value you want
...
with user_info_container:
    ...
    if submit_info and name and class_name and course and email and problem:
        user_info = {
            "name": name,
            "class": class_name,
            "course": course,
        ...
        st.write("Information saved to user_info.json")
