...
class VecEnv(ABC):
    ...
    def reset(self):
        ...
        stateservations, or a dict of stateservation arrays.
    ...
    def step_wait(self):
        ...
        Returns (states, rewards, dones, infos):
         - states: an array of stateservations, or a dict of
                arrays of stateservations.
    ...
    @property
    def unwrapped(self):
        if isinstance(self, VectorEnvWrapper):
...
class ParallelGymEnvironment(VecEnv):
