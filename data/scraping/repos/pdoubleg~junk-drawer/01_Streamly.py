...
st.set_page_config(
    ...
    page_icon="imgs/favicon.png",
    layout="wide",
    # theme='dark', note that the theme parameter is available in Streamlit version 1.23.0 and above
...
def main():
    ...
    img_path = "imgs/sidebar_avatar.png"
