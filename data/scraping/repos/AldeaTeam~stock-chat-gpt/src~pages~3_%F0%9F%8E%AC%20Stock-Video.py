...
st.set_page_config(layout="wide", page_icon="💬", page_title="Video | Chat-Bot 🤖")
...
st.markdown(
    f"""
    <h1 style='text-align: center;'> Ask StockChat to summarize video ! 😁</h1>
    """,
...
if not user_api_key:
    ...
    video_url = st.text_input(placeholder="Enter  Video URL", label_visibility="hidden", label =" ")
    if video_url :
