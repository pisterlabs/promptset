...
# MAGIC To run this demo, just select the cluster `dbdemos-llm-dolly-chatbot-goo_yejui` from the dropdown menu ([open cluster configuration](https://dbc-a46475b4-6677.cloud.databricks.com/#setting/clusters/1030-102129-5wyrl9sr/configuration)). <br />
...
# MAGIC <img width="1px" src="https://www.google-analytics.com/collect?v=1&gtm=GTM-NKQ8TT7&tid=UA-163989034-1&aip=1&t=event&ec=dbdemos&ea=VIEW&dp=%2F_dbdemos%2Fdata-science%2Fllm-dolly-chatbot%2F03-Q%26A-prompt-engineering-for-dolly&cid=8756440151868222&uid=4071615043034611">
