...
class DocsLoaderParameters(BaseParameters):
    ...
    Attributes:
        ...
        load_all_paths: Whether to load all docs pages or only a single one.
    """

    docs_uri: str = "https://docs.zenml.io"
    docs_base_url: str = "https://docs.zenml.io"
    load_all_paths: bool = False  # change to True to load ALL ZenML docs


@step
def gitbook_docs_loader_step(params: DocsLoaderParameters) -> List[Document]:
    ...
    loader = GitbookLoader(
        ...
        load_all_paths=params.load_all_paths,
    )
    return loader.load()
