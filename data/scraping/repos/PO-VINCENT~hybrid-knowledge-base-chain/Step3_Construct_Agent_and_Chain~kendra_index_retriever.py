...
class KendraIndexRetriever(BaseRetriever):
    ...
    def __init__(self, kendraindex, awsregion, k=3, return_source_documents=False, langcode='en'):
    ...
    def get_relevant_documents(self, query: str) -> List[Document]:
        ...
        """
        # print('-XX')
        docs = kendra_query(self.kclient, query, self.k, self.kendraindex, self.langcode)
        return docs
