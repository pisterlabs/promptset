...
class CameraHierarchicalMapping(ActionMapping): 
    ...
    """
    print("action_mapping.py CameraHierarchicalMapping start")
    ...
    def from_factored(self, ac: Dict) -> Dict:
        ...
        print("action_mapping.py ac['camera']: ", ac['camera'])
        print("action_mapping.py ac['buttons']: ", ac['buttons'])
        ...
        for i in range(ac["buttons"].shape[0]):
            ...
            print("action_mapping.py new_button_ac: ", new_button_ac) 
        ...
        print("action_mapping.py new_camera_ac: ", new_camera_ac)  
        return dict(
    ...
    def get_action_space_update(self):
        print("action_mapping.py get_action_space_update: self.BUTTONS_COMBINATIONS: ", self.BUTTONS_COMBINATIONS)
        return {
