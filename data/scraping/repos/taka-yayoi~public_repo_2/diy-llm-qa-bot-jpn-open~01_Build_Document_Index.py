...
# MAGIC
# MAGIC **注意** OpenAIEmbeddingsオブジェクトに必要なOpenAI API APIキーがnotebook 00で設定され、[こちらの手順](https://python.langchain.com/en/latest/ecosystem/openai.html#installation-and-setup)に従って環境変数で利用できるようになっている必要があります。
