...
if __name__ == "__main__":
    ...
    def generate_character_description(character_name):
        ...
        character_description = ChatOpenAI(openai_api_key=KEY.openai_api_key, temperature=1.0)(
            character_specifier_prompt
        ).content
    ...
    storyteller_description = ChatOpenAI(openai_api_key=KEY.openai_api_key, temperature=1.0)(
        storyteller_specifier_prompt
    ).content
    ...
    specified_quest = ChatOpenAI(openai_api_key=KEY.openai_api_key, temperature=1.0)(quest_specifier_prompt).content
    ...
    for character_name, character_system_message in zip(
        ...
        characters.append(
            DialogueAgent(
                ...
                model=ChatOpenAI(openai_api_key=KEY.openai_api_key, temperature=0.2),
            )
        )
