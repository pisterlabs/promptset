...
prompt2 = FewShotPromptTemplate(example_selector=example_selector, example_prompt=example_prompt, suffix="Question: {input}", input_variables=["input"])
print(prompt2.format(input="Who was the father of Mary Ball Washington?"))