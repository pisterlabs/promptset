...
from craftyai.prompts import load_prompt
from craftyai.control_primitives_context import load_control_primitives_context
...
class ActionAgent:
    ...
    def render_human_message(
        ...
        observation += f"Rewrite all the code + Put it in this format: ```js ... ```\n\n"
