...
def calcE(x, y):
    ...
    return abs((len(x)*sum_xy-sum_x*sum_y)/np.sqrt((len(x)*sum_x2-sum_x*sum_x)*(len(x)*sum_y2-sum_y*sum_y)))


data_ml_100k = read_json("ml-100k_NIR1.json")
