...
def parse_detection_result(detection_result):
    ...
    detection_result = detection_result.replace(" ", "").lower()
...
for i in range(0, len(data)):
    detection_result = data[i]["detection_result"]
    detection_result = parse_detection_result(detection_result)
    data[i] = {
...
for idx in range(0, len(predict_list_all)):
    ...
    item = {
        ...
        "label": label,
        "predict": predict,
        "change": data_dict[label_list_all[idx]["number"]]["change"],
    }
