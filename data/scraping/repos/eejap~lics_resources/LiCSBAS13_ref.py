#!/usr/bin/env python3
"""
v1.5.4 20230501 Lin Shen, Leeds Uni
...
'''
v1.5.4 20230501 Lin Shen, Leeds Uni
 - Change something to remove ifgs with high loop errors? (Jess Payne)
v1.5.3 20211122 Milan Lazecky, Leeds Uni
...
def main(argv=None):
    ...
    for i_patch, rows in enumerate(patchrow):
        ...
        ns_loop4ifg=ns_loop4ifg.transpose()
                
        
        unwpatch[ns_loop4ifg==0]=np.nan
        del ns_ifg4loop 
        del bool_loop 
