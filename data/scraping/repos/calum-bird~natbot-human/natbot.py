...
# Get the prompt from EveryPrompt
# You can view it here: https://everyprompt.com/trelent/functions/natbot/share
prompt = requests.get(
  "https://www.everyprompt.com/api/v0/functions/trelent/natbot",
  headers={
    "Content-Type": "application/json"
  }
)
ep_prompt = prompt.json()
prompt_template = ep_prompt.get("template", "")
openai_params = ep_prompt.get("options", {})
openai_params.pop("moderate")
