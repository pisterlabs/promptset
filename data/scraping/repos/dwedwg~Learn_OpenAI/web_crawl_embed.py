...
full_url = "https://microvision.com/"

#class to parse the HTML and get the links
...
df = pd.DataFrame(list_of_texts, columns = ['fname', 'text'])
...
print(answer_question(df, question="What is microvision?", debug=False))
