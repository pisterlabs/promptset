...
parser.add_argument("--hf_mode", default="tbi")
args, unknown = parser.parse_known_args()
if args.hf_mode == 'tbi':
    try:
        from .huggingface_client_bloom_inference import HuggingFaceClient # import transformers-bloom-inference
    except: 
        print("[auto_client.py] Cannot import transformers_bloom_inference! Use native HF instead ...")
        from .huggingface_client import HuggingFaceClient  # This is native HF interface
elif args.hf_mode == 'http':
    from .huggingface_http_client import HuggingFaceClient # using http to query transformers-bloom-inference
else:
    from .huggingface_client import HuggingFaceClient  # This is native HF interface
