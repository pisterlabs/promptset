...
INSTRUCTION = (
    "I developed an AI Chatbot and got feedback from humans that suggested how to"
    " make my chatbot better. Please use at most 6 words to summarize how the"
    " chatbot could be further improved."
)
