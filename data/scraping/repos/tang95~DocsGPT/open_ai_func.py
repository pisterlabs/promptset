...
# Function to create a vector store from the documents and save it to disk.
    ...
    os.environ["OPENAI_API_KEY"] = os.getenv("EMBEDDINGS_KEY")
    store = FAISS.from_documents(docs_test, OpenAIEmbeddings(openai_api_key=os.getenv("EMBEDDINGS_KEY"),model="text-embedding-ada-002"))
