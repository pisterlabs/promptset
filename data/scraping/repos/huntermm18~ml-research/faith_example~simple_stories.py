...
foi_keys = "age gender ethnicity religup".split() # XXX income paredu parsedu religup
...
for pid in tqdm(range(10)):
    for i in range(10): # per count. TODO: Change back to 20
...
newdf = pd.DataFrame({'ids':ids,'pids':prompt_ids, 'prompt':prompts, 'response':responses})
