    ...
    for i in range(int(args['max_episodes'])):
        ...
        for j in range(1, int(args['max_episode_len']) + 1):
            ...
            if j % int(args['sampling_time']) == 0:
                ...
                elif replay_buffer.size() <= int(args['minibatch_size'] * 5):
                    s *= st_dev
                    s += mean
            ...
            if replay_buffer.size() > int(args['minibatch_size'] * 5):
                ...
                if replay_buffer.size() == (int(args['minibatch_size'] * 5) + 1) and placeholder != 1:
                    placeholder = 1
                    mean, st_dev = replay_buffer.normalize()
                    print(mean, st_dev)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--max-episodes', help='max num of episodes to do while training', default=101)
