...
def synthesize_speech(text, output_filename):
    engine = pyttsx3.init()
    engine.setProperty('voice', 'ru') #com.apple.speech.synthesis.voice.milena  com.apple.speech.synthesis.voice.Samantha
    #
...
async def main():
    while True:
        ...
        with sr.Microphone() as source:
            ...
            print(f"Waiting for wake words 'bing' or 'ok chat'...")
            while True:
