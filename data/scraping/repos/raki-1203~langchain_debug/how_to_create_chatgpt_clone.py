...
if __name__ == '__main__':
    ...
    process and understand large aounts of text, and can use this knowledge to provide accurate and informative 
    responses to a wide range of questions. Additionally, Assistant is able to generate its own text baesd on the 
    ...
    output = chatgpt_chain.predict(human_input="I want you to act as a Linux terminal. I will type commands and you"
                                               ...
                                               "I instruct you to do so. When I nned to tell you something in English"
