...
def get_duckgpt_s3_conversation(
    ...
    return Conversation(
        ...
        monitoring=True,
        agents=[duckdb_s3_agent, duckgpt_file_agent],
        function_calls=True,
