...
csv_file = '220520_gpt3_aut_pilot.csv' 
...
temperature = np.array([.65, .66, .77, .78, .79, .80])
presence_penalty = 1
frequency_penalty = 1

# AUT variables Instructions to try
aut_object = ['book', 'fork', 'tin can']
instr = 'What are some creative uses for a {}? The goal is to come up with creative ideas, which are ideas that strike people as clever, unusual, interesting, uncommon, humorous, innovative, or different. List 10 creative uses for a {}.'
