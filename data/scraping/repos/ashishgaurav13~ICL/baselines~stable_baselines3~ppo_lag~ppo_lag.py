...
class PPOLagrangian(OnPolicyWithCostAlgorithm):
    ...
    def train(self) -> None:
        ...
        self.ppo_logger.update({
            ...
            "train/reward_value_loss": np.mean(reward_value_losses),
            "train/cost_value_loss": np.mean(cost_value_losses),
            "train/approx_kl": np.mean(approx_kl_divs),
            "train/clip_fraction": np.mean(clip_fractions),
            "train/loss": loss.item(),
            "train/mean_reward_advantages": mean_reward_advantages,
            "train/mean_cost_advantages": mean_cost_advantages,
            "train/reward_explained_variance": explained_reward_var,
            "train/cost_explained_variance": explained_cost_var,
            "train/nu": self.dual.nu().item(),
            "train/nu_loss": self.dual.loss.item(),
            "train/average_cost": average_cost,
            "train/total_cost": total_cost,
            "train/early_stop_epoch": early_stop_epoch,
