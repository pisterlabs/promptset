    ...
    def intro(self):
        ...
        with st.container():
            ...
            with col1:
                ...
                # gradient(*fft_riovanes_art[:3], f"Hi, I'm {full_name}👋", info["Intro"])
                gradient(blue_bath1[1], blue_bath1[3], blue_bath1[5], '#fcfbfb', f"Hi, I'm {full_name}👋", info["Intro"], 27)
                st.write("")
                st.write(info['About'])
                
            with col2:
                st_lottie(lottie_gif, height=260, key="data")
