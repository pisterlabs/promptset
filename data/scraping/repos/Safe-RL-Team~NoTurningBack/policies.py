...
from stable_baselines3_copy.common.distributions import (
...
from stable_baselines3_copy.common.preprocessing import get_action_dim, is_image_space, is_graph_space, preprocess_obs
from stable_baselines3_copy.common.torch_layers import BaseFeaturesExtractor, FlattenExtractor, MlpExtractor, NatureCNN, create_mlp
from stable_baselines3_copy.common.utils import get_device, is_vectorized_observation
...
class BasePolicy(BaseModel):
    ...
    def predict(
        ...
        if is_graph_space(self.observation_space):
