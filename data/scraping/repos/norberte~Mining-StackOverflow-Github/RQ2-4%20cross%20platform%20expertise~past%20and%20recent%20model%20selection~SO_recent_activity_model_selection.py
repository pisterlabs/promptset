...
logging.basicConfig(filename='/home/norberteke/PycharmProjects/Thesis/logs/SO_recent_optimizer_10000.log', format='%(asctime)s : %(levelname)s : %(message)s', level=logging.INFO)
config_path = "/home/norberteke/PycharmProjects/Thesis/data/SO_recent_model_parameter_config_log.csv"
runs = 8000
...
with open("/home/norberteke/PycharmProjects/Thesis/data/SO_recent_full_activity_corpus.txt", 'w') as f:
    for text in texts:
        f.write(str(text) + "\n")

dictionary = Dictionary.load("/home/norberteke/PycharmProjects/Thesis/data/SO_recent_full_activity_gensimDictionary.dict")
...
# this decorator allows your objective function to receive a value for the parameters as keyword arguments.
...
checkpoint_saver = CheckpointSaver("/home/norberteke/PycharmProjects/Thesis/data/new_SO_recent_param_optimizer_checkpoint.pkl")

#from skopt import load
#res = load('/home/norberteke/PycharmProjects/Thesis/data/new_SO_recent_param_optimizer_checkpoint.pkl')
#x0 = res.x_iters
#y0 = res.func_vals
...
try:
    dump(res_gp, '/home/norberteke/PycharmProjects/Thesis/data/new_SO_recent_param_optimizer_result_100.pkl', store_objective=True)
except:
    dump(res_gp,
             '/home/norberteke/PycharmProjects/Thesis/data/new_SO_recent_param_optimizer_result_without_objective_100.pkl', store_objective=False)
finally:
    try:
