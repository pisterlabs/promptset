...
def take_average_results(experiment,num_experiments,num_episodes,env,theta):
	...
	for i in range(num_experiments):
		...
		np.save('/Users/Riashat/Documents/PhD_Research/BASIC_ALGORITHMS/My_Implementations/Project_652/Code/Linear_Approximator/Exploration_Dependent_Sigma/Results/'  + 'Q_Sigma_On_Policy_Epsilon_Dependent_Cum_Rwd' + '.npy', average_reward)
		np.save('/Users/Riashat/Documents/PhD_Research/BASIC_ALGORITHMS/My_Implementations/Project_652/Code/Linear_Approximator/Exploration_Dependent_Sigma/Results/'  + 'Q_Sigma_On_Policy_Epsilon_Dependent_Cum_Err' + '.npy', average_error)
...
def main():
	...
	avg_cum_reward,avg_cum_error = take_average_results(Q_Sigma_On_Policy_Epsilon_Dependent,num_experiments,num_episodes,env,theta)
