...
def run(workspace: str,
    ...
    #       - general success threshold to consider the training and the experiment successful is -150.0 over 100 episodes (arbitrary, no guidelines provided)
