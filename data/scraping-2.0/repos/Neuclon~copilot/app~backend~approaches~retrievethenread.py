...
"You are an intelligent assistant helping users with answers to Aerospace and Defense standards, specifications and general questions. " + \
...
"If you cannot answer using the sources below, say you don't know. Use below example to answer"
    ...
    question = """
'Ask any question about any spec'
"""
    answer = "MIL-STD-461 is a standard that sets requirements for the control of electromagnetic interference, emissions, and susceptibility. It includes tests for radiated emissions, radiated susceptibilities, and their system effects, as well as hazards of electromagnetic radiation to ordnance (HERO), hazards of electromagnetic radiation to fuel (HERF), and hazards of electromagnetic radiation to personnel (HERP)  The standard also requires qualification data for electromagnetic interference and electromagnetic compatibility to be documented, including test conditions and results"
