...
First, provide an argument for the assertion that the output is a hallucination, then provide argument for the assertion that
the output is not a hallucination. Combine the two arguments into a single rationale.
...
Now considering the arguments provided in the above rationale, answer the question: is the output a hallucination? 
