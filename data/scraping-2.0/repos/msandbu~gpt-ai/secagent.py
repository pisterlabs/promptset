...
class TaskPrioritizationChain(LLMChain):
    ...
    def from_llm(cls, llm: BaseLLM, verbose: bool = True) -> LLMChain:
        ...
        task_prioritization_template = (
            "You are an AI agent focusing on finding security information and tasked with cleaning the formatting of and reprioritizing"
...
prefix = """You are an Security AI agent who performs one task based on the following objective: {objective}. Take into account these previously completed tasks: {context}."""
