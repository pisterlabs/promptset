...
# Run the experiment
responses_general = [llm.Completion.create(prompt) for prompt in general_prompts]
responses_specific = [llm.Completion.create(prompt) for prompt in specific_prompts]
