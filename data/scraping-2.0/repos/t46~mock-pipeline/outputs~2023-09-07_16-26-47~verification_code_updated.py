...
for question in questions:
    question['general_response'] = openai.Completion.create(engine="text-davinci-002", prompt=question['general'], max_tokens=60)
    question['specific_response'] = openai.Completion.create(engine="text-davinci-002", prompt=question['specific'], max_tokens=60)
