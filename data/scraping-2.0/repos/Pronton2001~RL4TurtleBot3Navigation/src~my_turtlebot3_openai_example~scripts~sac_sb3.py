...
#########################################################################
model_name = "/sb3_sac_s1_v100/model"
...
if __name__ == '__main__':
    ...
    n_observations = num_laser + 2
    n_actions = 5

    # Init OpenAI_ROS ENV
    task_and_robot_environment_name = "TurtleBot3Navigation-v1"
    ...
    # env = normalize.NormalizeActionWrapper(env) # SAC squash output already
    if enjoy:
