...
def RegisterOpenAI_Ros_Env(task_env, max_episode_steps=10000):
    ...
    elif task_env == 'TurtleBot3Navigation-v0':

        register(
            id=task_env,
            entry_point='openai_ros.task_envs.turtlebot3_nav.turtlebot3_nav:TurtleBot3NavEnv',
            max_episode_steps=max_episode_steps,
        )
    ...
    elif task_env == 'TurtleBot3Navigation-v1':

        register(
            id=task_env,
            entry_point='openai_ros.task_envs.turtlebot3_continuous_nav.turtlebot3_continuous_nav:TurtleBot3ContinuousNavEnv',
            max_episode_steps=max_episode_steps,
        )

        # import our training environment
        from openai_ros.task_envs.turtlebot3_continuous_nav import turtlebot3_continuous_nav
        
    elif task_env == 'TurtleBot3Navigation-v2':

        register(
            id=task_env,
            entry_point='openai_ros.task_envs.turtlebot3_continuous_nav_v2.turtlebot3_continuous_nav_v2:TurtleBot3ContinuousNavEnvV2',
            max_episode_steps=max_episode_steps,
        )

        # import our training environment
        from openai_ros.task_envs.turtlebot3_continuous_nav_v2 import turtlebot3_continuous_nav_v2
