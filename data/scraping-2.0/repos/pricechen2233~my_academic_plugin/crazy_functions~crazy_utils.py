        ...
        while True:
            ...
            try:
                ...
                result = predict_no_ui_long_connection(
                    inputs=inputs, llm_kwargs=llm_kwargs, chatbot=chatbot,
        ...
        while True:
            ...
            try:
                ...
                gpt_say = predict_no_ui_long_connection(
                    inputs=inputs, llm_kwargs=llm_kwargs, chatbot=chatbot, history=history, 
...
def get_files_from_everything(txt, type, username): # type='.md'
    """
    ...
    if txt.startswith('http'):
        ...
        with open('./gpt_log/'+username+'/temp'+type, 'wb+') as f: f.write(r.content)
        project_folder = './gpt_log/'+username
        file_manifest = ['./gpt_log'+username+'/temp'+type]
