...
def main():
    ...
    data = data[["description"]].sample(20000) #Running a sample for 20000 out of the 97k

    print("reading the data, this will take a few minutes")

    #This loop creates all titles as strings which then is appended to output
    nlp.max_length = len(data["description"])
    output = []
    ...
    pyLDAvis.save_html(vis, "../output/lda-board_wine.html")
