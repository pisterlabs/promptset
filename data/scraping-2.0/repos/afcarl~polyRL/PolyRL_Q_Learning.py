...
Algorithm
"""
def Poly_Q_Learning(env, w_param, num_episodes, discount_factor=1.0, alpha = 0.001, epsilon=0.1, epsilon_decay=1.0, sigma = 0.05, L_p = 200, b_step_size = 1, length_polymer_chain = 500):
...
def main():
	...
	stats_poly_q_learning = Poly_Q_Learning(env, w_param, num_episodes, epsilon=0.1)
