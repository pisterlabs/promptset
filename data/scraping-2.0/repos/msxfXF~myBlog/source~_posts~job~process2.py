...
LastEditTime: 2023-08-15 19:38:45
LastEditors: 孙浩飞 sun.msxf@bytedance.com
Description: 
FilePath: /workspace/myBlog/source/_posts/job/process2.py
'''
    ...
    for file in files:
        ...
        for i, item in enumerate(data):
            ...
            if count >= 1:
                ...
                time.sleep(3.5)
                with open(os.path.join(current_path, subject + "_claude2.txt"), 'a', encoding="utf-8") as f:
                    ans = answer
                    # ans = ans.replace("\n", "\n\n")
