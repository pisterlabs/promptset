...
class FireflyMultiAgentGTEnv(robot_gazebo_env.RobotGazeboEnv):
    ...
    def __init__(self, ros_ws_abspath,**kwargs):
        ...
        * /command, publishes the desired waypoints and velocity for the robot. Type: uav_msgs
        ...
        rospy.Subscriber(self.noisy_joints_topic, AlphaRes, self._noisy_joints_callback)
        rospy.Subscriber(self.noisy_joints_neighbor_topic, AlphaRes, self._noisy_joints_neighbor_callback)
        rospy.Subscriber(self.noisy_bbox_topic, AlphaRes, self._noisy_bbox_callback)
        rospy.Subscriber(self.noisy_bbox_neighbor_topic, AlphaRes, self._noisy_bbox_neighbor_callback)
    ...
    def get_noisy_joints(self):
        return self.noisy_joints

    def get_noisy_joints_neighbor(self):
        return self.noisy_joints_neighbor

    def get_noisy_bbox(self):
        return self.noisy_bbox

    def get_noisy_bbox_neighbor(self):
        return self.noisy_bbox_neighbor
