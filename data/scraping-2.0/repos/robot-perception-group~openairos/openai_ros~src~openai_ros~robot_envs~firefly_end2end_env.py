...
class FireflyMultiAgentEnv(robot_gazebo_env.RobotGazeboEnv):
    ...
    def __init__(self, ros_ws_abspath,**kwargs):
        ...
        * /command, publishes the desired waypoints and velocity for the robot. Type: uav_msgs
        ...
        super(FireflyMultiAgentEnv, self).__init__(controllers_list=self.controllers_list,
    ...
    def create_circle(self, radius=5):
        self.theta = np.arange(1.57,2,0.1)
