...
from openai_ros.robot_envs import firefly_env, firefly_multiagent_gt_inf_env,firefly_multiagent_sync_env,firefly_multiagent_alpha_env
...
class DeepFollowEnv(firefly_multiagent_alpha_env.FireflyMultiAgentGTEnv):
    ...
    def _set_action(self, action):
        ...
        self.move_base(control, self.prediction_horizon, update_rate=5)
    ...
    def _compute_reward(self, observations, done):
        ...
        if not done:
            ...
            [flag,error] = self.get_lsq_triangulation_error(observations,epsilon=1)
