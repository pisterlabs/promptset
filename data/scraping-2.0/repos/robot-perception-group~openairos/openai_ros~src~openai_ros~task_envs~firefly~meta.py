...
class DeepFollowEnv(metaSim_env.FireflyMultiAgentGTEnv):
    ...
    def _get_obs(self):
        ...
        observations_sa =  [delta_target1.pose.pose.position.x, delta_target1.pose.pose.position.y, delta_target1.pose.pose.position.z,\
                        relative_vel[0],relative_vel[1],relative_vel[2],np.cos(theta1), np.sin(theta1),np.cos(delta_orient1), np.sin(delta_orient1)]


        #Dummy zero inputs to value network during testing. 
        value_input_ma = [0]*len(list(gt)+[pose.position.x,pose.position.y,pose.position.z,pose_neighbor.position.x,\
        ...
        observations_ma = [delta_target1.pose.pose.position.x, delta_target1.pose.pose.position.y, delta_target1.pose.pose.position.z,\
        ...
        observations = observations_sa+value_input_sa+observations_ma+value_input_ma
