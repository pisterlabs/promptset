...
class FireflyMultiAgentGTEnv(robot_gazebo_env.RobotGazeboEnv):
    ...
    def __init__(self, ros_ws_abspath,**kwargs):
        ...
        * /command, publishes the desired waypoints and velocity for the robot. Type: uav_msgs
        ...
        gt_neighbor = message_filters.Subscriber(self.gt_neighbor_pose_topic, uav_pose)
        ...
        self.alphapose_cache = message_filters.Cache(alphapose,100);self.alphapose_cache.registerCallback(self._alphapose_callback)
        ...
        self.alphapose_bbox_cache= message_filters.Cache(alphapose_bbox,100)

        alphapose_bbox_neighbor = message_filters.Subscriber(self.alphapose_bbox_neighbor_topic, AlphaRes)
        self.alphapose_bbox_neighbor_cache = message_filters.Cache(alphapose_bbox_neighbor,100)

        mhmr = message_filters.Subscriber(self.mhmr_topic, PoseArray)
        self.mhmr_cache = message_filters.Cache(mhmr,100)
