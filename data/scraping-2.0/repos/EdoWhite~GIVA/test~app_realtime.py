# the problem is that is continuously send text to GPT and answers to the prompt came later and are overlapped
...
def chat(openAI_key, audio, state=""):
...
gr.Interface(
    ...
    inputs=[
        ...
        gr.Audio(label="Record", source="microphone", type="numpy", streaming=True),
        "state"
    ],
    outputs=[
