...
st.set_page_config(page_title="PolGPT - Chat med MF'ere", page_icon="🏛️")
st.title("🏛️ PolGPT - Chat med MF'ere")

# Build sidebar
with st.sidebar:
    openai_api_key = st.text_input("OpenAI API Key", key="langchain_search_api_key_openai", type="password")
    "[Få en OpenAI API key](https://platform.openai.com/account/api-keys)"
...
if "messages" not in st.session_state:
    st.session_state["messages"] = [
        {"role": "assistant", "content": "Hej, jeg er en chatbot, der har adgang til referater fra Folketinget. Hvordan kan jeg hjælpe dig?"}
    ]
