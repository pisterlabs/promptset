...
def launch(args):
    ...
    trainer.visualize_ad_attack(
        'saved_models/FetchPickAndPlace-v1/ddpg/protagonist_ddpg_agent_hidden_unit_512_ad_factor0.4.pt',
        'saved_models/FetchPickAndPlace-v1/ddpg/adversary_ddpg_agent_hidden_unit_512_ad_factor0.4.pt')
