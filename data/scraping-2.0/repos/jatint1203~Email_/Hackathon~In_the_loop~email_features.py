...
def receive_emails():
    ...
    phishing_email = email_phishing(email_list[0][2])
    
    return (email_list, len(mail_ids) , phishing_email)


def email_phishing(phishing_email):
    import requests

    url = "https://api.apilayer.com/spamchecker?threshold=threshold"

    payload = f"{phishing_email}".encode("utf-8")
    headers= {
    "apikey": "KoVjsXziKHtqkXvXtaJJ29ZTkxLVfDuV"
    }
...
def openAI(title):
    ...
    openai.api_key ="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"
