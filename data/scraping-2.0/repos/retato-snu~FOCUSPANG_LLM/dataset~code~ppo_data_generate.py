...
dataset_path = './hello/line_human-touched.json'
dataset_gpt_path = './hello/line_gpt.json'
result_path = "./ppo_dataset.json"
openai.api_key = os.environ.get('OPENAI_API_KEY')

impulsiveness_student_data = []
impulsiveness_class_data=[]
quizpang_student_data=[]
quizpang_class_data=[]
