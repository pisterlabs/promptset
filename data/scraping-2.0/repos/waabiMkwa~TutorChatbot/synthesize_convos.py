...
def gpt3_completion(prompt, engine='text-davinci-002', temp=0.85, top_p=1.0, tokens=1000, freq_pen=0.03, pres_pen=0.5, stop=['<<END>>']):  # NOTE: original temp was 0.7 and freq_pen was 0.0 - I turned these up to reduce repetition
    max_retry = 5
    retry = 0
    while True:
        try:
...
if __name__ == '__main__':
    for i in range(0, 4):
        ...
        for topic in topics:
            ...
            outtext = 'User: Hey KINOOMAAGANSE%s' % response
            print(outtext)
