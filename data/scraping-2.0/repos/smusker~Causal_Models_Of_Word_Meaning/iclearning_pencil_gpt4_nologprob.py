...
kwargs={"temperature":0.7,"max_tokens":5,"top_p":1,"frequency_penalty":0,"presence_penalty":0}#, "engine":"text-davinci-002"}#,"logprobs":10} #"engine":"text-davinci-002",
...
for n in range(samples_per_q):
    ...
    raw_response=openai.ChatCompletion.create(
        model="gpt-4-0314",
        messages=[
                {"role": "system", "content": "You are a helpful assistant with an excellent understanding of the physical world."},#"You are a helpful assistant."},#"You are a helpful assistant with an excellent understanding of the physical world."},
    ...
    if "yes" in word_response.lower():
        is_yes=1

    sum_yes_int+=is_yes

sum_yes=(sum_yes_int)/samples_per_q #this is percent yeses for this q
