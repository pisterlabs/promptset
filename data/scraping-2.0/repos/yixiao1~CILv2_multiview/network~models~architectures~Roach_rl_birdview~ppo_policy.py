...
class PpoPolicy(nn.Module):
    ...
    def __init__(self,
        ...
        features_extractor_entry_point = 'network.models.architectures.Roach_rl_birdview.'+features_extractor_entry_point.split('.')[-1]
        distribution_entry_point = 'network.models.architectures.Roach_rl_birdview.'+distribution_entry_point.split('.')[-1]
