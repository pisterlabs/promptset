...
tools = [StockPriceTool(), MoveFileTool()]
...
result = open_ai_agent.run("What is the price of Google stock?")
print(result)
...
print(
    f"The best performing stock over the past {days_ago} days is {best_stock} with a performance of {best_performance}%")
...
class StockPercentageChangeTool(BaseTool):
    ...
    description = ("Useful for when you need to find out the percentage change in a stock's value. You should input "
                   "the stock ticker used on the yfinance API and also input the number of days to check the change "
                   "over")
...
class StockGetBestPerformingTool(BaseTool):
    ...
    description = ("Useful for when you need to the performance of multiple stocks over a period. You should input a "
                   "list of stock tickers used on the yfinance API and also input the number of days to check the "
                   "change over")
...
result = open_ai_agent.run("Which stock out of Google, Meta and MSFT has performed best over the past 3 months?")
print(result)
result = open_ai_agent.run("How much has Bitcoin gone up over the past 3 months??")
print(result)
