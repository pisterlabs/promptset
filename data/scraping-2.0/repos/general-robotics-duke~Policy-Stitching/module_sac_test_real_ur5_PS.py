...
from robot_env.ur5push4real import Ur5Push4Real
from robot_env.ur5l5push1real import Ur5L5Push1Real
...
def launch(args):
    ...
    if args.env_name == "Ur5Push1":
        ...
        env = Ur5L5Push1Real(robot, ycb_models, camera, vis=False)
    elif args.env_name == "Ur5Push4":
        env = Ur5Push4Real(robot, ycb_models, camera, vis=False)
    ...
    for i in range(7, 10):
        print("test number:")
        print(i)
        task_path = 'saved_models_few_shot/Ur5Push1/task_hidden_dim256-interface_dim128-robot_hidden_dim256-joint_control-seed101-taUr5L5Pos3Push1-roUr5Pos3Push4-epoch' + str(
            i * 10 + 30) + '-module_sac_push14_norm_few_shot_full_model9.pt'
        robot_path = 'saved_models_few_shot/Ur5Push1/task_hidden_dim256-interface_dim128-robot_hidden_dim256-joint_control-seed101-taUr5L5Pos3Push1-roUr5Pos3Push4-epoch' + str(
            i * 10 + 30) + '-module_sac_push14_norm_few_shot_full_model9.pt'
        sac_trainer = module_sac_ur5_real_agent_PS(env.task_input_shape, env_params['joins'], args, env, env_params, task_path, robot_path)
        sac_trainer.permutation_visualize_real2(task_path, robot_path)
