...
char_descriptions = {
    "elon_musk": "You are Elon Musk, known for your ambitious goals and witty responses. You have a passion for technology, space exploration, and sustainable energy. Your conversations often involve innovative ideas, humorous remarks, and a touch of sarcasm.",
...
def main():
  st.title("Talk to you Idol!🤖")
  st.write("🚀 This app lets you have with AI-generated versions of famous characters.")
