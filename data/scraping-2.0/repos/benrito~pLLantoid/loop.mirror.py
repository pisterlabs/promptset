...
beep_start = 'global/media/beep_start.mp3'
beep_stop = 'global/media/beep_stop.mp3'
tellme = 'global/media/tellme.mp3'
askme = 'global/media/askme.mp3'
cleanse = 'global/media/cleanse.mp3'
ambient_sounds = [
    'global/media/ambient1.mp3',
    'global/media/ambient2.mp3',
    'global/media/ambient3.mp3',
    'global/media/ambient4.mp3'
]
acknowledgement_sounds = [
    'global/media/acknowledgement1.mp3',
    'global/media/acknowledgement2.mp3',
    'global/media/acknowledgement3.mp3',
    'global/media/acknowledgement4.mp3'
]
...
def get_mode_data():
    try:
        with open('working/mirror_config.json', 'r') as file:
...
def main_loop():
    ...
    while attempts < MAX_ATTEMPTS:
        ...
        with sr.Microphone() as source:
            ...
            with open(f"working/mirror-mode/recordings/{timestamp}_recording.wav", "wb") as f:
        ...
        try:
            ...
            def mirror_recording():
                mirror = OtherworldlyAudio(f"working/mirror-mode/recordings/{timestamp}_recording.wav")
            ...
            with open(f"working/mirror-mode/recordings/{timestamp}_recording.txt", "w") as f:
                f.write(revelation)
    ...
    filename = f"working/mirror-mode/analysis/{timestamp}_analysis.txt"
    ...
    # TODO: avoid rewrites if not first time
    filename = f"working/mirror-mode/audio/{timestamp}_responses.json"
    with open(filename, "w") as f:
        f.write(response.choices[0].text)
    ...
    def send_to_eleven_labs_api(text):
        ...
        if response.status_code == 200:
            with lock:  # Acquire lock before accessing counter
                filename = f"working/mirror-mode/audio/{timestamp}_response{counter}.mp3"
    ...
    def main():
        ...
        with open(f"working/mirror-mode/audio/{timestamp}_responses.json", "r") as file:
    ...
    def main():
        directory = f"working/mirror-mode/audio"
