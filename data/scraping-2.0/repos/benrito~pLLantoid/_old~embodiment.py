...
def load_character_configs(filename="config_characters.json"):
...
class ChannelAPI:
    ...
    def start_threads_staggered(self, worker_func, channel, text, character, timestamp, delay=5):
        # Start the thread
...
def load_characters_from_config(api, config_file="working/config_characters.json"):
