...
beep_start = 'working/shadow_bathing/media/beep_start.wav'
    ...
    while attempts < MAX_ATTEMPTS:
        ...
        try:
            ...
            def mirror_recording():
                ...
                print(mirror)
                print(f"working/{current_mode}/recordings/{timestamp}_recording.wav")
            ...
            # if os.path.exists(acknowledgement):
            #     print("File exists.")
            # else:
