...
while True:
    ...
    if user_input == '0':
        user_input = input("Type secondary command: ")
        if user_input == '0':
            start_img = "start1.png"
        elif user_input == '1':
    ...
    # Update sliders
        ...
        user_input = input("Type abstractness value: ")
        abstractness_slider = float(user_input) #using this float function is likely not required in the serial version of this code
        user_input = input("Type transformation value: ")
        transformation_slider = float(user_input)
