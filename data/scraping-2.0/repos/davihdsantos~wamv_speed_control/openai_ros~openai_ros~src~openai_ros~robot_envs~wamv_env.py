...
class WamvEnv(robot_gazebo_env.RobotGazeboEnv):
    ...
    def __init__(self):
        ...
        * /cmd_drive: You publish the speed of the left and right propellers.
        ...
        rospy.Subscriber("/wamv/robot_localization/odometry/filtered", Odometry, self._odom_callback)
    ...
    def _check_odom_ready(self):
        ...
        while self.odom is None and not rospy.is_shutdown():
            try:
                self.odom = rospy.wait_for_message("/wamv/robot_localization/odometry/filtered", Odometry, timeout=1.0)
    ...
    def set_propellers_speed(self, right_propeller_speed, left_propeller_speed, time_sleep=1.0):
        ...
        usv_drive_obj = Float32()
        usv_drive_obj.data = left_propeller_speed
        self.publishers_array[0].publish(usv_drive_obj)

        usv_drive_obj = Float32()
        usv_drive_obj.data = right_propeller_speed
        self.publishers_array[1].publish(usv_drive_obj)
