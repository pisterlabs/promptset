...
ASTRA_DB_SECURE_BUNDLE_PATH= env['ASTRA_DB_SECURE_BUNDLE_PATH']
ASTRA_DB_APPLICATION_TOKEN = env['ASTRA_DB_APPLICATION_TOKEN'] 
ASTRA_DB_CLIENT_ID = env['ASTRA_DB_CLIENT_ID']
ASTRA_DB_CLIENT_SECRET= env['ASTRA_DB_CLIENT_SECRET']
