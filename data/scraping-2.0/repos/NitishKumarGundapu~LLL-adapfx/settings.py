...
def parse_args():
    ...
    parser.add_argument("--prefixlength",type=int,default=30)
    parser.add_argument("--leaveout",type=str,default="")
    parser.add_argument("--rf",type=int,default=4)
    parser.add_argument("--bottle_neck_size",type=int,default=800)
