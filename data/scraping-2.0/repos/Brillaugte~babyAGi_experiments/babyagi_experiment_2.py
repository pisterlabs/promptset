...
def professor_agent(objective: str, this_task_id: int) -> str:
  ...
  #print("\n*******RELEVANT CONTEXT******\n")
  #print(context)
  prompt = f"You are an a researcher who verifiate that an AI who try to accomplish {objective}.\nTake into account his previously completed tasks: {context}, are the next tasks he propose are coherent to solve {objective} given the max 2000token and limited capabilities of an AI.Be extremly severe before answering True. Your answer will only following these rules, If you think tasks are coherent start your answer by True, if no return 5 detailed correction he can make"
