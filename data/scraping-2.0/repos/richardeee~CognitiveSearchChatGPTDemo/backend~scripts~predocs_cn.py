...
parser.add_argument("--folder", required=False, help="Azure Blob Storage container folder name")
...
def upload_blobs(filename):
    ...
    if os.path.splitext(filename)[1].lower() == ".pdf":
        ...
        with open(filename,"rb") as data:
            blob_container.upload_blob(remote_file_path, data, overwrite=True)
