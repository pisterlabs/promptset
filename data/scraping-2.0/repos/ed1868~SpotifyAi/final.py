...
def add_songs_to_spotify(playlist_prompt, playlist):
    ...
    spotipy_redirect_url = "https://ainomads.netlify.app/"  # Your browser will return page not found at this step. We'll grab the URL and paste back in to our console
