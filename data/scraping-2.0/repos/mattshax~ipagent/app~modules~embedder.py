...
class Embedder:
    ...
    def storeDocEmbeds(self, file, original_filename):
        ...
        with open(f"{self.PATH}/{original_filename.replace('../','')}.pkl", "wb") as f:
    ...
    def getDocEmbeds(self, file, original_filename):
        ...
        """
        if not os.path.isfile(f"{self.PATH}/{original_filename.replace('../','')}.pkl"):
            self.storeDocEmbeds(file, original_filename)

        # Load the vectors from the pickle file
        with open(f"{self.PATH}/{original_filename.replace('../','')}.pkl", "rb") as f:
