...
from whispersplitparser import WhisperSplitParser

class TimedAudioExtractor(AudioExtractor):
    ...
    def audio_to_text(self, urls,save_dir):
        ...
        try:
            ...
            loader = GenericLoader(YoutubeAudioLoader(urls, save_dir), WhisperSplitParser())
