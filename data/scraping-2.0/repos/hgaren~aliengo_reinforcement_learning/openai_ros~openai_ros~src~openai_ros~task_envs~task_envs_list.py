...
def RegisterOpenAI_Ros_Env(task_env, max_episode_steps=10000):
    ...
    if task_env == 'AliengoStand-v0':

        register(
            id=task_env,
            entry_point='openai_ros.task_envs.aliengo.aliengo_stand:AliengoStandEnv',
            max_episode_steps=max_episode_steps,
        )
        # import our training environment
        from openai_ros.task_envs.aliengo import aliengo_stand
