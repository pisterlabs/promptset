...
class Persona:
    def __init__(self, personality_type='truthful'):
        ...
        prompt_template_null = """Say I don't know
        {context}
        {question}
        ...
        Question: {question}
        The context is given above the "###". Use the context given above the "###" to provide a detailed answer. If the context does not provide the answer, say the answer cannot be found from the 
        given context and give the answer based on your knowledge. Always start with Actually....
        """
        ...
        * END OF CONTEXT
        ...
        Read all the answers carefully and give the most correct answer and the reason for that.
        
        [Letter of the Answer]: [Answer]
        ...
        prompt_template_expander = """
        {context}
        You are given a passage, and at the end, a question is asked.
        Your task is to expand the passage and the question fully to make it easy to understand. Mention what the possibilities are and stress on important points. Guess differential diagnoses if applicable and mention them. After expanding the passage and the question, mention the question as a Direct question, not as an MCQ.

        Passage: {question}
        
        Expanded passage and the direct question:
        """

        prompt_template_guesser = """
        ...
        Provide the answer to the question in the passage, with the help of detaild from the TEXTBOOK CHAPTER
        """

        
        prompt_template_transformer = """
        {context}
        ...
        * END OF THE TEXTBOOK CHAPTER

        NOW READ THIS PASSAGE AND THE QUESTION
        ...
        elif personality_type == 'expander':
            prompt_template = prompt_template_expander
        elif personality_type == 'guesser':
            prompt_template = prompt_template_guesser
        elif personality_type == 'refiner':
            prompt_template = prompt_template_refiner
        elif personality_type == 'transformer':
            prompt_template = prompt_template_transformer
        elif personality_type == 'null':
            prompt_template = prompt_template_null
        else:
