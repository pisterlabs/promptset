...
def simple_lemmatize(s:list,stop_words:list=[]):
    """
    Parameters
    ----------
    s : list
        list of strings (tokenized string).
...
def replace_nums(string,dictionary=None,regex="(?<!\d)\d(?!\d)"):
    """
    Replace digits by alphanumeric numbers. 
    ...
    regex : str, optional
        Regular expression string to use as regex command in RE. The default is "(?<!\d)\d(?!\d)" for single digit replacement only.
...
def string_pre_processing(input_str:str,stemming_method:str='PorterStemmer',stop_words_extra:list=None,
                          punctuation_removal:bool=True,lowercase:bool=True,tag_removal:bool=True,special_char_removal:bool=True,
                          stop_word_removal:bool=True,lemmatization=False,download_nltk:bool=True,verbose:bool=False):
# =============================================================================
...
# =============================================================================
    ...
    for row in iterable_of_iterabls:
        doc = []
        for word in row:
