...
@add_start_docstrings(
    "The bare OpenAI GPT transformer nezha_model outputing raw hidden-states without any specific head on top.",
...
class TFOpenAIGPTModel(TFOpenAIGPTPreTrainedModel):
    ...
    Examples::
        ...
        nezha_model = TFOpenAIGPTModel.from_pretrained('openai-gpt')
...
class TFOpenAIGPTLMHeadModel(TFOpenAIGPTPreTrainedModel):
    ...
    Examples::
        ...
        tokenizer = OpenAIGPTTokenizer.from_pretrained('openai-gpt')
        nezha_model = TFOpenAIGPTLMHeadModel.from_pretrained('openai-gpt')
        input_ids = tf.constant(tokenizer.encode("Hello, my dog is cute", add_special_tokens=True))[None, :]  # Batch size 1
        outputs = nezha_model(input_ids)
        logits = outputs[0]
...
class TFOpenAIGPTDoubleHeadsModel(TFOpenAIGPTPreTrainedModel):
    ...
    Examples::
        ...
        tokenizer = OpenAIGPTTokenizer.from_pretrained('openai-gpt')
        nezha_model = TFOpenAIGPTDoubleHeadsModel.from_pretrained('openai-gpt')
