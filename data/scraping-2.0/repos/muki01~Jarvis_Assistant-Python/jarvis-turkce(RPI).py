...
def greeting():
    ...
    if hour >= 6 and hour < 12:
        Speak("Günaydın efendim, sizin için ne yapabilirim")
    elif hour >= 12 and hour < 18:
        Speak("Iyi günler efendim, sizin için ne yapabilirim")
    else:
        Speak("Iyi akşamlar efendim, sizin için ne yapabilirim")
...
def respond():
    ...
    if query == "jarvis":
        ...
        or "hayır" in query
        or "sus" in query
        or "kapa çeneni" in query
        or "susabilirsin" in query
        or "bekle" in query
        or "bir saniye bekle" in query
    ):
        Speak("Tamam efendim")
        ...
        "güzel iş" in query
        or "bravo" in query
        or "harika iş" in query
        or "harikasın" in query
        or "helal olsun" in query
    ):
    ...
    ################################################      INFORMATION ABOUT JARVIS
        ...
        Speak(
            "Tüm dilleri konuşabiliyorum fakat beni bunun için yeniden kodlamanız gerek efendim"
        )

    elif (
        "babanın ismi ne" in query
        or "annenin ismi ne" in query
        or "baban kim" in query
        or "annen kim" in query
    ):
        Speak("Benim babam da annem de Muhsin efendim")

    elif "ne yapabiliyorsun" in query:
        Speak(
            "Sizinle sohbet edebilirim, saat ve tarih söyleyebilirim, Google, Vikipedive YouTube de arama yapabilirim, uygulama açıp kapatabilirim, ve evdeki ışıkları kontrol edebilirim"
        )
    ...
    ######################INFORMATION ABOUT ME
        ...
        "benim ismim ne" in query
        or "benim adım ne" in query
        or "ben kimim" in query
        or "bu kim" in query
    ):
        ...
        Speak(
            "Sizin isminizin anlamı İyilik eden, iyi ve güzel işler yapan, iyilikte bulunan demek efendim"
        )
    ...
    ####################CLOCK DATE
        ...
        "tarih" in query
        or "bugün günlerden ne" in query
        or "bugünkü tarihi söylermisin" in query
    ):
        ...
        Speak(
            f"Zimovina da hava {int(temp)} derece, nem 100 de {humidity} ve gökyüzü {description} efendim"
        )
    ...
    ################################################################################################
        ...
        "ets 2 aç" in query
        or "euro truck simulator 2 aç" in query
        or "ets2 aç" in query
    ):
    ...
    #######################   MEDIA
        ...
        "şarkıyı aç" in query
        or "şarkıyı kapat" in query
        or "müziği aç" in query
        or "müziği kapat" in query
        or "türküyü aç" in query
        or "türküyü kapat" in query
    ):
        pyautogui.press("playpause")
        Speak("Tamam efendim")

    elif (
        "şarkıyı değiştir" in query
        or "sonraki şarkı" in query
        or "sonraki şarkıya geç" in query
    ):
        ...
        "ses seviyesini" in query
        and "yükselt" in query
        or "ses seviyesini" in query
        and "yüksel" in query
    ):
        try:
    ...
    #####################################################################
        ...
        "hız testi yap" in query
        or "internet testi yap" in query
        or "wifi testi yap" in query
    ):
    ...
    ###################################################################################
        ...
        "osur" in query
        or "osuruk sesi" in query
        or "gaz çıkart" in query
        or "gaz çıkar" in query
    ):
