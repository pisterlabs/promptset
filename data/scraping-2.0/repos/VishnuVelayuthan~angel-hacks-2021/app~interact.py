...
class Chatbot:
    ...
    def run(self):
        ...
        self.model = model
        self.args = args
        return history, tokenizer, personality, model, args
    ...
    def predict(self, raw_text):
        ...
        history = self.history[-(2*self.args.max_history+1):]
        out_text = self.tokenizer.decode(out_ids, skip_special_tokens=True)
        return out_text


    # def predict(self, raw_text, history, tokenizer, personality, model, args):
    #     if not raw_text:
    #         return "Please say something."
    #     history.append(tokenizer.encode(raw_text))
    #     with torch.no_grad():
