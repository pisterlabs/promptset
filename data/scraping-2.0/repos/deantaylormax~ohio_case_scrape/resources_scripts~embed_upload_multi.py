...
def main():
    ...
    variable1 = "District_3"
    variable2 = "District_4"

    # Create two processes
    process1 = multiprocessing.Process(target=process_district_year_files, args=(variable1,))
    process2 = multiprocessing.Process(target=process_district_year_files, args=(variable2,))
    # Start the processes
    process1.start()
    process2.start()
...
# process_district_year_files(root_directory, 'District_2', checkpoint_path)