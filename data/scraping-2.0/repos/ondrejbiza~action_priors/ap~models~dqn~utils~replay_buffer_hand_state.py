...
class ReplayBuffer(object):
    ...
    def _encode_sample(self, idxes):
        depths, hand_states, actions, rewards, next_depths, next_hand_states, dones = [], [], [], [], [], [], []
        for i in idxes:
            ...
            next_depths.append(next_state[0])
            next_hand_states.append(next_state[1])
            dones.append(done)
        return depths, hand_states, actions, rewards, next_depths, next_hand_states, dones
