...
class MathpixPDFLoader(BasePDFLoader):
    ...
    def headers(self) -> dict:
        print(
            f"Using Mathpix API key: {self.mathpix_api_key} and ID: {self.mathpix_api_id}"
        )
    ...
    def send_pdf(self) -> str:
        ...
        if "pdf_id" in response_data:
            ...
            raise ValueError(
                "Unable to send PDF to Mathpix. Response: " + response.text
            )
    ...
    def get_processed_pdf(self, pdf_id: str) -> str:
        ...
        print(f"get_processed_pdf URL: {url}")
        print(f"get_processed_pdf headers: {self.headers}")
        response = requests.get(url, headers=self.headers)
        print(f"get_processed_pdf Response: {response}")
