...
system_message_prompt = SystemMessagePromptTemplate("You are a helpful assistant that answers ONLY questions about health, supplement, vitamins, and sport.")


# Input field for the user to ask the chatbot a question
if prompt := st.chat_input(placeholder="Based on the information I provided, what supplement would you recommend?"):
  st.chat_message("user").write(prompt)
  human_message_prompt = HumanMessagePromptTemplate(f"{prompt}")
