...
class APIRequestor:
    def __init__(
        self, key=None, api_base=None, api_auth_header=None, api_version=None, organization=None):
    ...
    def request_headers(
        self, api_auth_header, method: str, extra, request_id: Optional[str]
    ) -> Dict[str, str]:
    ...
    def request_raw(
        ...
        headers = self.request_headers(my_auth_header, method, headers, request_id)
