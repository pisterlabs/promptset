...
def main():
    ...
    with st.form(key='stilovi', clear_on_submit=True):
        ...
        tema = st.text_input(
            'Enter the instructions like lenght, topic, language, formatting...:')
    ...
    if submit_button:
        ...
        with st.spinner("Trazim stil..."):
            ...
            prompt = f"Kao vrhunski bloger napisi {tema} koristeci ovaj primer kao osnovu za stil pisanja: {osnova}. "
