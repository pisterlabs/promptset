...
class Trainer:
    ...
    def get_metrics(self):
        ...
        umass = Coherence(texts=self.data.get_corpus(), topk=self.topk, measure="u_mass")
        ...
        metrics = [(coherence_npmi, "Coherence_npmi"),(coherence_umass, "Coherence_umass"), (diversity, "Diversity")]
