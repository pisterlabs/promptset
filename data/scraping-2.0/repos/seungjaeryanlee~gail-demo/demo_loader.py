...
https://github.com/openai/baselines/blob/master/baselines/gail/dataset/mujoco_dset.py
...
if __name__ == '__main__':
    ...
    parser.add_argument("--expert_path", type=str, default="./data/stochastic.trpo.Hopper.0.00.npz")
