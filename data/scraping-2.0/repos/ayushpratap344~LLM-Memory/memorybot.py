...
st.set_page_config(page_title='MemoryBot by Ayush', layout='wide')
...
with st.sidebar.expander("Sidebar ", expanded=False):
...
st.title("Chat Bot with Memory by Ayush")
...
if API_O:
    ...
    st.sidebar.warning('Enter API key to try this app.')
    # st.stop()
