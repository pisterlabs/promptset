""" Trains an LDA Mallet model on the Mag data set (with bigrams, snowball stemming)."""
...
filename = '/home/ashwath/Programs/MAGCS/MAG-hyperdoc2vec/input/mag_training_data.txt'
# memory-hungry
print("Starting")
try:
    ...
    del data_bigrams
try:
    id2word_dictionary = corpora.Dictionary.load('mag.dict')
except FileNotFoundError:
    id2word_dictionary = corpora.Dictionary(data_stemmed)
    id2word_dictionary.save('mag.dict')  # save dict to disk
...
try:
    ...
    try:
        corpora.MmCorpus.serialize('mag_bow_corpus.mm', corpus)  # save corpus to disk
