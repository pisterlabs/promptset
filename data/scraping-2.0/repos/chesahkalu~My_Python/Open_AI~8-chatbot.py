...
def get_completion_from_messages(messages, model="gpt-3.5-turbo", temperature=0): # gpt-3.5-turbo is the default model
    response = openai.ChatCompletion.create(   # ChatCompletion is the endpoint, create is the method
        model=model,                                                
        messages=messages,
...
# this is the list of messages that have been exchanged in the conversation so far. Each message is a dictionary with two keys: role and content. The role key specifies the role of the message sender, and the content key specifies the message content.
