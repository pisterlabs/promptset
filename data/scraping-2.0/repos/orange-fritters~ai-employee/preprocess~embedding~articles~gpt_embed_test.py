...
if __name__ == "__main__":
    ...
    with open("preprocess/embedding/log.txt", "a") as log:
        TEXT = "아르바이트로만 생활하고 있는데 정식으로 일을 찾고 싶어."
        ...
        embed_json = json.load(open('data/embeddings.json', 'r'))

        data_len = len(os.listdir('data/articles'))
