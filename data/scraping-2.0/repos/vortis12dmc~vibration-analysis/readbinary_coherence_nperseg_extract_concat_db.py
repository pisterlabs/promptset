...
if arguments_count < 7:
    print("Usage: "+args[0]+" <信号1の前半> <信号1の後半> <信号2の前半> <信号2の後半> <nperseg> <閾値>")
    sys.exit(1)
...
readFile2_2 = args[4]
npseg = int(args[5])
threshold_val = int(args[6])  #30  #信号部分の切り出し閾値
...
accTitle1 = "Raw " +sprit_readFile1[5]+'/'+sprit_readFile1[6]+'/'+ axis1 + "-axis" 
accTitle2 = "Raw " +sprit_readFile2[5]+'/'+sprit_readFile2[6]+'/'+ axis2 + "-axis"
powTitle1 = "Pow " +sprit_readFile1[5]+'/'+sprit_readFile1[6]+'/'+ axis1 + "-axis"
powTitle2 = "Pow " +sprit_readFile2[5]+'/'+sprit_readFile2[6]+'/'+ axis2 + "-axis"
plotTitle = sprit_readFile1[5]+'/'+sprit_readFile1[6]+'/'+ axis1 + "-axis" +' & '+sprit_readFile2[5]+'/'+sprit_readFile2[6]+'/'+ axis2 + "-axis_npseg-"+str(npseg)
crosTitle = "Cros " +sprit_readFile1[5]+'/'+sprit_readFile1[6]+'/'+ axis1 + "-axis" +'&'+sprit_readFile2[5]+'/'+sprit_readFile2[6]+'/'+ axis2 + "-axis"
coheTitle = "Coherence " +sprit_readFile1[5]+'/'+sprit_readFile1[6]+'/'+ axis1 + "-axis" +'&'+sprit_readFile2[5]+'/'+sprit_readFile2[6]+'/'+ axis2 + "-axis"
writeFile = writeFilePass+sprit_readFile1[5]+'_'+sprit_readFile1[6]+'_'+ axis1 + "axis" +'__'+sprit_readFile2[5]+'_'+sprit_readFile2[6]+'_'+ axis2 + "axis" + "_coherence_npseg-"+str(npseg)+".png"
