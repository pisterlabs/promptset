...
class BaseModel(nn.Module, ABC):
    ...
    def save(self, path: str) -> None:
        ...
        print("data", self._get_constructor_parameters())
...
class ActorCriticPolicy(BasePolicy):
    ...
    def _get_latent(self, obs: th.Tensor) -> Tuple[th.Tensor, th.Tensor, th.Tensor]:
        ...
        #print('latent_pi is:', latent_pi)
        #print('latent_vf is:', latent_vf)
        # Features for sde
        latent_sde = latent_pi
        if self.sde_features_extractor is not None:
            latent_sde = self.sde_features_extractor(features)
        #print('latent_sde is:', latent_sde)
    ...
    def _predict(self, observation: th.Tensor, deterministic: bool = False) -> th.Tensor:
        ...
        temp1= distribution.get_actions(deterministic=deterministic)
        #temp2 = distribution.lxc_log_prob_from_params(temp1)
