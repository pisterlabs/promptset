"""
Taken from: https://github.com/lm-sys/FastChat/blob/main/fastchat/serve/monitor/topic_clustering.py
...
## wpq: remove fastchat dependency
...
def read_texts(input_file, min_length, max_length, english_only):
    """ Treat each user's `content` as `text`. """
    visited = set()
    texts = []
