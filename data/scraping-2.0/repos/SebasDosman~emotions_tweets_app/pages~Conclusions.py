...
def construir_mensaje():
    try:
        ...
        st.components.v1.html(
            '<img src="https://media2.giphy.com/media/yJil9u57ybQ9movc6E/giphy.gif?cid=ecf05e47s72rt1y7ev7779rz96vk405kbzb0b745slavs56r&rid=giphy.gif" alt="GIF">',
            width=600,
            height=300,
        )
        return MENSAJE
...
def conclusiones():
    ...
    try:
        ...
        if emocion_principal(datos_emociones) == "Muy enojados":
            st.components.v1.html(
                '<img src="https://media.tenor.com/lTe5PjawzRAAAAAC/furia-intensamente.gif" alt="GIF">',
                width=600,
                height=300,
            )
            ...
            st.components.v1.html(
                '<img src="https://media.tenor.com/WS55YpItsqIAAAAC/enserio-deverdad.gif" alt="GIF">',
                width=600,
                height=300,
            )
            st.components.v1.html("<br>")
            ...
            st.components.v1.html(
                '<img src="https://st1.uvnimg.com/dims4/default/40b28a9/2147483647/thumbnail/480x270/quality/75/format/jpg/?url=https%3A%2F%2Fuvn-brightspot.s3.amazonaws.com%2Fassets%2Fvixes%2Fbtg%2Fgiphy_77_0.gif" alt="GIF">',
                width=600,
                height=300,
            )
            st.components.v1.html("<br>")
            ...
            st.components.v1.html(
                '<img src="https://i.pinimg.com/originals/b5/49/f7/b549f732fa170a0cbd6629fd5654c2dd.gif" alt="GIF">',
                width=600,
                height=400,
            )
            st.components.v1.html("<br>")
            ...
            st.components.v1.html(
                '<img src="https://media.tenor.com/ZUkMEj5iYkAAAAAd/kun-aguero-dance.gif" alt="GIF">',
                width=600,
                height=450,
            )
            st.components.v1.html("<br>")
        ...
        st.write(
            "Nos banearon de OpenAI por hacer tantas peticiones, pero relájate horrible profe"
        )

        info = traducir_texto(
            "Nos banearon de OpenAI por hacer tantas peticiones, pero relájate profe",
            "es",
            "en",
        )
        st.write(info)
