"""Config flow for ChatGPT Conversation integration."""
...
class ConfigFlow(config_entries.ConfigFlow, domain=DOMAIN):
    """Handle a config flow for ChatGPT Conversation."""
    ...
    async def async_step_user(
        ...
        try:
            ...
            return self.async_create_entry(title="ChatGPT Conversation", data=user_input)
...
class OptionsFlow(config_entries.OptionsFlow):
    """ChatGPT config flow options handler."""
    ...
    async def async_step_init(
        ...
        if user_input is not None:
            return self.async_create_entry(title="ChatGPT Conversation", data=user_input)
        schema = chatgpt_config_option_schema(self.config_entry.options)
        return self.async_show_form(
            step_id="init",
...
def chatgpt_config_option_schema(options: MappingProxyType[str, Any]) -> dict:
    """Return a schema for ChatGPT completion options."""
    if not options:
