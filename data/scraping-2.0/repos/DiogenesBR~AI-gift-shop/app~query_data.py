...
def get_product_list(relationship, age, occasion, interests, budget):
    ...
    # define the prompt
    gift_suggestions = guidance("""I'm looking for a gift, my relationship with the recipient is {{relationship}}. The recipient is {{age}} years old. The occasion is {{occasion}}. The recipient's interests and hobbies are {{interests}} I can give something related. My budget is {{budget}} dollars. Please suggest some gift ideas.
