...
def write_content(research_material, topic):
    ...
    writer = autogen.AssistantAgent(
        ...
        system_message="You are a professional AI blogger who is writing a blog post about AI, you will write a short "
                       "blog post based on the structured provided by the editor, and feedback from reviewer; After 2 "
...
writing_assistant = autogen.AssistantAgent(
    ...
    system_message="You are a writing assistant, you can use research function to collect latest information about a "
                   "given topic, and then use write_content function to write a very well written content; Reply "
                   "TERMINATE when your task is done",
...
user_proxy.initiate_chat(
    writing_assistant, message="Write an article comparing the performance of the top 10 technology stocks in the "
                               "last 5 years. Use Yahoo finance data.")
