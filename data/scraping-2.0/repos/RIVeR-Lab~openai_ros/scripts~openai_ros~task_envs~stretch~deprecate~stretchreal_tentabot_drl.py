...
from openai_ros.robot_envs import stretchreal_env
...
DESCRIPTION: TODO...
'''
class StretchRealTentabotDRL(stretchreal_env.StretchRealEnv):
    ...
    def __init__(self, robot_id=0, data_folder_path=""):
        ...
        super(StretchRealTentabotDRL, self).__init__(robot_namespace=self.robot_namespace, velocity_control_msg=self.config.velocity_control_msg)

        self.get_goal_location()
        self.init_observation_action_space()

        #print("stretchreal_tentabot_drl::__init__ -> obs laser shape: " + str(self.obs["laser"].shape))
        #print("stretchreal_tentabot_drl::__init__ -> obs target_action shape: " + str(self.obs["target_action"].shape))
    ...
    def _init_env_variables(self):
        ...
        print("--------------")
        print("stretchreal_tentabot_drl::_init_env_variables -> self.robot_id: {}".format(self.robot_id))
        print("stretchreal_tentabot_drl::_init_env_variables -> self.step_num: {}".format(self.step_num))
        print("stretchreal_tentabot_drl::_init_env_variables -> self.total_step_num: {}".format(self.total_step_num))
        print("stretchreal_tentabot_drl::_init_env_variables -> self.episode_num: {}".format(self.episode_num))
        print("stretchreal_tentabot_drl::_init_env_variables -> self.total_collisions: {}".format(self.total_collisions))
        print("stretchreal_tentabot_drl::_init_env_variables -> self.episode_reward: {}".format(self.episode_reward))
        print("stretchreal_tentabot_drl::_init_env_variables -> self.total_mean_episode_reward: {}".format(self.total_mean_episode_reward))
        print("--------------")
        ...
        '''
        print("stretchreal_tentabot_drl::_init_env_variables -> BEFORE client_reset_map_utility")
        # Reset Map
        success_reset_map_utility = self.client_reset_map_utility()
        print("stretchreal_tentabot_drl::_init_env_variables -> AFTER client_reset_map_utility")
        '''

        # We wait a small ammount of time to start everything because in very fast resets, laser scan values are sluggish
        # and sometimes still have values from the prior position that triggered the done.
        print("stretchreal_tentabot_drl::_init_env_variables -> Initializing environment...")
        time.sleep(1.0)
        print("stretchreal_tentabot_drl::_init_env_variables -> Environment is initialized!")
        self.init_flag = True

        self.previous_distance2goal = self.get_distance2goal()
        print(f"stretchreal_tentabot_drl::_init_env_variables -> distance2goal is {self.previous_distance2goal}")
    ...
    def _is_done(self, observations):
        ...
        if self._episode_done and (not self._reached_goal):
            ...
            rospy.logdebug("stretchreal_tentabot_drl::_is_done -> Boooo! Episode done but not reached the goal...")
            print("stretchreal_tentabot_drl::_is_done -> Boooo! Episode done but not reached the goal...")

        elif self._episode_done and self._reached_goal:

            rospy.logdebug("stretchreal_tentabot_drl::_is_done -> Gotcha! Episode done and reached the goal!")
            print("stretchreal_tentabot_drl::_is_done -> Gotcha! Episode done and reached the goal!")
            
        else:

            rospy.logdebug("stretchreal_tentabot_drl::_is_done -> Not yet bro...")
            #print("stretchreal_tentabot_drl::_is_done -> Not yet bro...")
    ...
    def _compute_reward(self, observations, done):
        ...
        #print("stretch_tentabot_drl::_compute_reward -> self.total_step_num: " + str(self.total_step_num))
        ...
        if self._episode_done and (not self._reached_goal):
            ...
            #print("stretch_tentabot_drl::_compute_reward -> reward_step: " + str(reward_step))
            ...
            #print("stretch_tentabot_drl::_compute_reward -> init_distance2goal: " + str(self.init_distance2goal))
            print("stretch_tentabot_drl::_compute_reward -> max_episode_steps: " + str(self.config.max_episode_steps))
            print("stretch_tentabot_drl::_compute_reward -> reward_terminal_success: " + str(self.config.reward_terminal_success))
            print("stretch_tentabot_drl::_compute_reward -> reward_step_scale: " + str(self.config.reward_step_scale))
            print("stretch_tentabot_drl::_compute_reward -> penalty_terminal_fail: " + str(self.config.penalty_terminal_fail))
            print("stretch_tentabot_drl::_compute_reward -> penalty_cumulative_step: " + str(self.config.penalty_cumulative_step))
            print("stretch_tentabot_drl::_compute_reward -> penalty_step: " + str(penalty_step))
            print("stretch_tentabot_drl::_compute_reward -> rp_step: " + str(rp_step))
            print("stretch_tentabot_drl::_compute_reward -> step_reward: " + str(self.step_reward))
            #print("stretch_tentabot_drl::_compute_reward -> dt: " + str(dt))
            #print("stretch_tentabot_drl::_compute_reward -> max_lateral_speed: " + str(self.config.max_lateral_speed))
            #print("stretch_tentabot_drl::_compute_reward -> max_step_reward: " + str(round(self.config.max_lateral_speed * dt, self.config.mantissa_precision)))
            print("----------------------")
            '''
            
        self.episode_reward += self.step_reward

        rospy.logdebug("stretch_tentabot_drl::_compute_reward -> step_reward: " + str(self.step_reward))
        rospy.logdebug("stretch_tentabot_drl::_compute_reward -> episode_reward: " + str(self.episode_reward))
        rospy.logdebug("stretch_tentabot_drl::_compute_reward -> total_step_num: " + str(self.total_step_num))

        '''
        print("**********************")
        print("stretch_tentabot_drl::_compute_reward -> self.step_reward: " + str(self.step_reward))
        print("----------------------")
        '''
        ...
        #     print("stretch_tentabot_drl::save_oar_data -> episode_oar_data obs len: " + str(len(self.episode_oar_data['obs'])))
        #     print("stretch_tentabot_drl::save_oar_data -> episode_oar_data acts len: " + str(len(self.episode_oar_data['acts'])))
    ...
    def get_init_pose(self, init_flag=True):
        ...
        if self.world_name == "training_garden_static_0":
            ...
            #print("stretchreal_tentabot_drl::get_init_pose -> Updated initial_pose x: " + str(self.initial_pose["x_init"]) + ", y: " + str(self.initial_pose["y_init"]))
            rospy.logdebug("stretchreal_tentabot_drl::get_init_pose -> Updated initial_pose x: " + str(self.initial_pose["x_init"]) + ", y: " + str(self.initial_pose["y_init"]))
        ...
        for i, scan_range in enumerate(laser_scan.ranges):
            ...
            if (self.config.obs_min_range > scan_range > self.config.laser_error_threshold):
                ...
                if not self._episode_done:
                    ...
                    rospy.logdebug("stretchreal_tentabot_drl::check_collision -> Hit me baby one more time!")
                    print("stretchreal_tentabot_drl::check_collision -> Hit me baby one more time!")
                    print("stretchreal_tentabot_drl::check_collision -> collision_counter: " + str(collision_counter))
    ...
    def init_observation_action_space(self):
        ...
        if self.config.observation_space_type == "lidar_FC":
            ...
            #print("stretchreal_tentabot_drl::init_observation_action_space -> obs_laser_low shape: " + str(obs_laser_low.shape))
            #print("stretchreal_tentabot_drl::init_observation_action_space -> obs_target_low shape: " + str(obs_target_low.shape))
            #print("stretchreal_tentabot_drl::init_observation_action_space -> obs_action_low shape: " + str(obs_action_low.shape))
            ...
            #print("stretchreal_tentabot_drl::init_observation_action_space -> obs_data laser shape: " + str(self.obs_data["laser"].shape))
            #print("stretchreal_tentabot_drl::init_observation_action_space -> obs_data target shape: " + str(self.obs_data["target"].shape))
            #print("stretchreal_tentabot_drl::init_observation_action_space -> obs_data action shape: " + str(self.obs_data["action"].shape))
            ...
            #print("stretchreal_tentabot_drl::init_observation_action_space -> obs_stacked_laser_low shape: " + str(obs_stacked_laser_low.shape))
            #print("stretchreal_tentabot_drl::init_observation_action_space -> obs_space_low shape: " + str(obs_space_low.shape))
            ...
            #print("stretchreal_tentabot_drl::init_observation_action_space -> obs_occupancy_low shape: " + str(obs_occupancy_low.shape))
            #print("stretchreal_tentabot_drl::init_observation_action_space -> obs_target_low shape: " + str(obs_target_low.shape))
            #print("stretchreal_tentabot_drl::init_observation_action_space -> obs_action_low shape: " + str(obs_action_low.shape))
            ...
            #print("stretchreal_tentabot_drl::init_observation_action_space -> obs_data occupancy shape: " + str(self.obs_data["occupancy"].shape))
            #print("stretchreal_tentabot_drl::init_observation_action_space -> obs_data target shape: " + str(self.obs_data["target"].shape))
            #print("stretchreal_tentabot_drl::init_observation_action_space -> obs_data action shape: " + str(self.obs_data["action"].shape))
            ...
            #print("stretchreal_tentabot_drl::init_observation_action_space -> obs_stacked_occupancy_low shape: " + str(obs_stacked_occupancy_low.shape))
            #print("stretchreal_tentabot_drl::init_observation_action_space -> obs_space_low shape: " + str(obs_space_low.shape))
            ...
            #print("stretchreal_tentabot_drl::init_observation_action_space -> obs_space_occupancy_low shape: " + str(obs_space_occupancy_low.shape))
            #print("stretchreal_tentabot_drl::init_observation_action_space -> obs_space_target_action_low shape: " + str(obs_space_target_action_low.shape))
            ...
            #print("stretchreal_tentabot_drl::init_observation_action_space -> obs_laser_low shape: " + str(obs_laser_low.shape))
            #print("stretchreal_tentabot_drl::init_observation_action_space -> obs_target_low shape: " + str(obs_target_low.shape))
            #print("stretchreal_tentabot_drl::init_observation_action_space -> action_space_low shape: " + str(action_space_low.shape))
            ...
            #print("stretchreal_tentabot_drl::init_observation_action_space -> obs_space_laser_low shape: " + str(obs_space_laser_low.shape))
            #print("stretchreal_tentabot_drl::init_observation_action_space -> obs_space_target_action_low shape: " + str(obs_space_target_action_low.shape))
        ...
        #print("stretchreal_tentabot_drl::init_observation_action_space -> observation_space: " + str(self.observation_space))
        #print("stretchreal_tentabot_drl::init_observation_action_space -> action_space: " + str(self.action_space))
    ...
    def reinit_observation(self):
        ...
        if self.config.observation_space_type == "lidar_FC":
            ...
            #print("stretchreal_tentabot_drl::reinit_observation -> filtered_laser_ranges shape: " + str(self.filtered_laser_ranges.shape))
            #print("stretchreal_tentabot_drl::reinit_observation -> obs_target shape: " + str(self.obs_target.shape))
            #print("stretchreal_tentabot_drl::reinit_observation -> previous_action shape: " + str(self.previous_action.shape))

            #print("stretchreal_tentabot_drl::reinit_observation -> obs_data laser shape: " + str(self.obs_data["laser"].shape))
            #print("stretchreal_tentabot_drl::reinit_observation -> obs_data target shape: " + str(self.obs_data["target"].shape))
            #print("stretchreal_tentabot_drl::reinit_observation -> obs_data action shape: " + str(self.obs_data["action"].shape))

            # Initialize observation
            obs_stacked_laser = np.hstack([obs_laser] * self.config.n_obs_stack)

            #print("stretchreal_tentabot_drl::reinit_observation -> obs_stacked_laser shape: " + str(obs_stacked_laser.shape))

            self.obs = np.concatenate((obs_stacked_laser, self.obs_target, self.previous_action), axis=0)

            #print("stretchreal_tentabot_drl::reinit_observation -> obs: " + str(self.obs.shape))
            ...
            if not success_rl_step:
                rospy.logerr("stretchreal_tentabot_drl::reinit_observation -> OBSERVATION FAILURE!")
            ...
            #print("stretchreal_tentabot_drl::reinit_observation -> occupancy_set shape: " + str(self.occupancy_set.shape))
            #print("stretchreal_tentabot_drl::reinit_observation -> obs_target shape: " + str(self.obs_target.shape))
            #print("stretchreal_tentabot_drl::reinit_observation -> previous_action shape: " + str(self.previous_action.shape))

            #print("stretchreal_tentabot_drl::reinit_observation -> obs_data occupancy shape: " + str(self.obs_data["occupancy"].shape))
            #print("stretchreal_tentabot_drl::reinit_observation -> obs_data target shape: " + str(self.obs_data["target"].shape))
            #print("stretchreal_tentabot_drl::reinit_observation -> obs_data action shape: " + str(self.obs_data["action"].shape))
            ...
            #print("stretchreal_tentabot_drl::reinit_observation -> obs_stacked_occupancy shape: " + str(obs_stacked_occupancy.shape))
            ...
            #print("stretchreal_tentabot_drl::reinit_observation -> obs_space_occupancy shape: " + str(obs_space_occupancy.shape))
            #print("stretchreal_tentabot_drl::reinit_observation -> obs_space_target_action shape: " + str(obs_space_target_action.shape))
            ...
            #print("stretchreal_tentabot_drl::reinit_observation -> laser shape: " + str(self.filtered_laser_ranges.shape))
            #print("stretchreal_tentabot_drl::reinit_observation -> obs_target shape: " + str(self.obs_target.shape))
            #print("stretchreal_tentabot_drl::reinit_observation -> previous_action shape: " + str(self.previous_action.shape))
            ...
            #print("stretchreal_tentabot_drl::reinit_observation -> obs_space_laser shape: " + str(obs_space_laser.shape))
            #print("stretchreal_tentabot_drl::reinit_observation -> obs_space_target_action shape: " + str(obs_space_target_action.shape))
    ...
    def update_observation(self):
        ...
        if self.config.observation_space_type == "lidar_FC":
            ...
            #print("stretchreal_tentabot_drl::update_observation -> obs_data laser shape: " + str(self.obs_data["laser"].shape))
            #print("stretchreal_tentabot_drl::update_observation -> obs_data target shape: " + str(self.obs_data["target"].shape))
            #print("stretchreal_tentabot_drl::update_observation -> obs_data action shape: " + str(self.obs_data["action"].shape))

            # Update observation
            obs_stacked_laser = self.obs_data["laser"][-1,:].reshape(self.config.fc_obs_shape)

            #print("stretchreal_tentabot_drl::update_observation -> obs_stacked_laser shape: " + str(obs_stacked_laser.shape))
            ...
            #print("stretchreal_tentabot_drl::update_observation -> obs: " + str(self.obs.shape))
            ...
            #print("stretchreal_tentabot_drl::update_observation -> obs_space_laser: " + str(obs_space_laser.shape))
            #print("stretchreal_tentabot_drl::update_observation -> obs_space_target_action: " + str(obs_space_target_action.shape))
            ...
            success_rl_step = self.client_rl_step(1)
            if not success_rl_step:
                rospy.logerr("stretchreal_tentabot_drl::update_observation -> OBSERVATION FAILURE!")
            ...
            #print("stretchreal_tentabot_drl::update_observation -> obs_data occupancy shape: " + str(self.obs_data["occupancy"].shape))
            #print("stretchreal_tentabot_drl::update_observation -> obs_data target shape: " + str(self.obs_data["target"].shape))
            #print("stretchreal_tentabot_drl::update_observation -> obs_data action shape: " + str(self.obs_data["action"].shape))
            ...
            #print("stretchreal_tentabot_drl::update_observation -> obs_stacked_occupancy shape: " + str(obs_stacked_occupancy.shape))
            #print("stretchreal_tentabot_drl::update_observation -> obs_target shape: " + str(self.obs_target.shape))
            #print("stretchreal_tentabot_drl::update_observation -> previous_action shape: " + str(self.previous_action.shape))
            ...
            if self.config.cit_flag:
                ...
                #print("stretchreal_tentabot_drl::update_observation -> obs_space_occupancy: " + str(obs_space_occupancy.shape))
            ...
            #print("stretchreal_tentabot_drl::update_observation -> obs_space_occupancy: ")
            #print(obs_space_occupancy[0, 65:75])
            #print("stretchreal_tentabot_drl::update_observation -> obs_target dist: " + str(self.obs_target[0,0]))
            #print("stretchreal_tentabot_drl::update_observation -> obs_target angle: " + str(self.obs_target[0,1] * 180 / math.pi))
            #print("stretchreal_tentabot_drl::update_observation -> previous_action: " + str(self.previous_action))
            #print("****************")
    ...
    def publish_move_base_goal(self):
        ...
        print("stretchreal_tentabot_drl::publish_move_base_goal -> x: " + str(self.goal_pose["x"]) + " y: " + str(self.goal_pose["y"]) + " z: " + str(self.goal_pose["z"]))
    ...
    def client_rl_step(self, parity):
        ...
        try:
            ...
            '''
            print("--------------")
            print("stretchreal_tentabot_drl::client_rl_step -> min id: " + str(np.argmin(self.occupancy_set)) + " val: " + str(np.min(self.occupancy_set)))
            print("stretchreal_tentabot_drl::client_rl_step -> max id: " + str(np.argmax(self.occupancy_set)) + " val: " + str(np.max(self.occupancy_set)))
            print("stretchreal_tentabot_drl::client_rl_step -> ")
            ...
            print("stretchreal_tentabot_drl::client_rl_step -> Service call failed: %s"%e)
            return False
    ...
    def client_update_goal(self):
        ...
        try:
            ...
            print("stretchreal_tentabot_drl::get_goal_location -> Updated goal_pose x: " + str(self.goal_pose["x"]) + ", y: " + str(self.goal_pose["y"]))
            ...
            if(success):
                #print("stretchreal_tentabot_drl::get_goal_location -> Updated goal_pose x: " + str(self.goal_pose["x"]) + ", y: " + str(self.goal_pose["y"]))
                rospy.logdebug("stretchreal_tentabot_drl::client_update_goal -> Updated goal_pose x: " + str(self.goal_pose["x"]) + ", y: " + str(self.goal_pose["y"]))
            else:
                #print("stretchreal_tentabot_drl::client_update_goal -> goal_pose is NOT updated!")
                rospy.logdebug("stretchreal_tentabot_drl::client_update_goal -> goal_pose is NOT updated!")

            return success

        except rospy.ServiceException as e:  
            print("stretchreal_tentabot_drl::client_update_goal -> Service call failed: %s"%e)
            return False
    ...
    def client_reset_map_utility(self, parity):
        ...
        try:
            ...
            if(success):
                print("stretchreal_tentabot_drl::client_reset_map_utility -> Map is reset!")
                rospy.logdebug("stretchreal_tentabot_drl::client_reset_map_utility -> Map is reset!")
            else:
                print("stretchreal_tentabot_drl::client_reset_map_utility -> Map is NOT reset!")
                rospy.logdebug("stretchreal_tentabot_drl::client_reset_map_utility -> Map is NOT reset!")
    ...
    def client_move_base_get_plan(self):
        ...
        try:
            ...
            if(len(self.move_base_global_plan)):
                ...
                #print("stretchreal_tentabot_drl::client_move_base_get_plan -> move_base plan is received!")
                rospy.logdebug("stretchreal_tentabot_drl::client_move_base_get_plan -> move_base plan is received!")
                success = True
