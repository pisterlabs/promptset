...
from rl.env import GymEnv, AtariRamEnv, AtariEnv, LabEnv, ArmEnv
EnvDict = {"gym":       GymEnv,                 # classic control games from openai w/ full-state-vector as input
           ...
           "atari":     AtariEnv, 
           "arm":       ArmEnv,              # atari integrations from openai, with pixel-level input
           "lab":       LabEnv}                 # TODO

from rl.model import MlpModel, CnnModel, A3CMlpModel, A3CCnnModel, ArmModel
ModelDict = {"mlp":     MlpModel,               # for full-state  input envs
             ...
             "a3c-cnn": A3CCnnModel,
             "a3c-arm": ArmModel}            # for pixel-level input envs
