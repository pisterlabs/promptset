...
clamp_index = [0.03]*50+[0.04]*100+[0.05]*1850 #@param {type:'raw'}
clamp_index = 1*np.array(clamp_index)
sat_index =   [0]*40+[0]*2000 #@param {type:'raw'}
sat_index = np.array(sat_index)
range_index = [0]*50 +[0]*1950 #@param {type:'raw'}
...
RN101 = settings['RN50'] #@param {type:"boolean"}
