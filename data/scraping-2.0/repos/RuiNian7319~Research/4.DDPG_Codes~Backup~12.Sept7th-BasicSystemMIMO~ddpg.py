...
from Basic_MIMO_System import BasicSystem
...
if __name__ == '__main__':
    ...
    parser.add_argument('--max-episodes', help='max num of episodes to do while training', default=151)
    parser.add_argument('--max-episode-len', help='max length of 1 episode', default=250)
    ...
    # Run the function
    Actor, Critic, Environment = main(Args)
