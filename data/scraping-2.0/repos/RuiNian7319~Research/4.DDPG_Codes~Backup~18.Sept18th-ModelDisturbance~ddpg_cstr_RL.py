...
def main(args):
    ...
    with tf.Session() as sess:
        ...
        env = MimoCstr(nsim=args['max_episode_len'], x0=np.array([0.927, 317.78, 0.659]), u0=np.array([295, 0.1]),
                       k0=9.2e10)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--max-episodes', help='max num of episodes to do while training', default=801)
    parser.add_argument('--max-episode-len', help='max length of 1 episode', default=39)
