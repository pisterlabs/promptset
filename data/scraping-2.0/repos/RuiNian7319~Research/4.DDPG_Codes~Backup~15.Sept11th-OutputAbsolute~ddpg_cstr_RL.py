...
class CriticNetwork(object):
    ...
    def __init__(self, sess, state_dim, action_dim, learning_rate, tau, gamma, num_actor_vars):
        ...
        # Get the gradient of the critic neural network w.r.t. the action.
...
def main(args):
    ...
    with tf.Session() as sess:
        ...
        env = MimoCstr(nsim=args['max_episode_len'], x0=np.array([0.952, 312.7, 0.659]), u0=np.array([290, 0.1]))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--max-episode-len', help='max length of 1 episode', default=45)
