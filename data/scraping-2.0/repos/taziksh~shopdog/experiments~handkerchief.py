...
class Handkerchief():
    ...
    async def retrieve(self, messages, chunk):
        ...
        return await aclient.chat.completions.create(messages=messages, model='gpt-3.5-turbo-16k')
    ...
    def generate(self, messages, results, **openai_kwargs):
        ...
        return client.chat.completions.create(messages=messages, **openai_kwargs)
