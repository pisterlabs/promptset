...
class AzureCognitiveSearchSemanticRetriever(AzureCognitiveSearchRetriever):
    ...
    def _build_search_url(self, query: str) -> str:
        ...
        endpoint_path = f"indexes/{self.index_name}/docs?api-version={self.api_version}&$top=1&queryLanguage=zh-CN&queryType=semantic&captions=extractive&answers=extractive|count-3&semanticConfiguration=default"
    ...
    def _search(self, query: str) -> List[dict]:
        ...
        resultValue= json.loads(result)["value"]
