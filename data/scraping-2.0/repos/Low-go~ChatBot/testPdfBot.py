...
from langchain.text_splitter import CharacterTextSplitter #had to downgrade to python 3.11.0 to get this to install properly
...
#processes pdf information and stores information in variable
pdf_reader = PdfReader(r"E:\projects\Chat-AiBot\assets\constitution.pdf") #test one, constitution of the united states
text = ""
