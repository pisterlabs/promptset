    ...
    def __init__(self, capacity, operation, neutral_element):
        ...
        Can be used as regular array, but with two important differences:
            ...
            b) user has access to an efficient ( O(log segment size) )
               `reduce` operation which reduces `operation` over a contiguous subsequence of items in the array.
        ...
        operation: lambda obj, obj -> obj
            ...
            must form a mathematical group together with the set of possible values for array elements 
            (i.e. be associative)
        neutral_element: obj
            neutral element for the operation above. eg. float('-inf') for max and 0 for sum.
        """
...
class SumSegmentTree(SegmentTree):
    ...
    def find_prefixsum_idx(self, prefixsum):
        ...
        if array values are probabilities, 
        this function allows to sample indexes according to the discrete probability efficiently.
