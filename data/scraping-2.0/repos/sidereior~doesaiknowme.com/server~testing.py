...
assistant_prompt_instruction = """tell me about Alexander Nanda, a student at Dartmouth college. 
Be sure to be specific and talk about all aspects of Alexander Nanda.
...
def tavily_search(query):
    search_result = tavily.get_search_context(query, search_depth="advanced", max_tokens=8000)
