...
def construct_index(directory_path):
    ...
    llm_predictor = LLMPredictor(llm=OpenAI(temperature=0, model_name="gpt-4", max_tokens=num_outputs,openai_api_key="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"))
