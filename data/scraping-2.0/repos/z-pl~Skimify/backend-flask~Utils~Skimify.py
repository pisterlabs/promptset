...
class SkimifyTool():
    """
    A tool for converting dot points into more descriptive text using OpenAI GPT-4 Turbo.
    ...
    def dotpointToText(self, dotpoint: str) -> str:
        """Expand the input dot point into a more descriptive text using OpenAI GPT-4 Turbo.
