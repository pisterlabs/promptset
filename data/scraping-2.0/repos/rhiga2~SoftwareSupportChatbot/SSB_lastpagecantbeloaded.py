...
question = 'Q: How do I generate a box detail report in imanage records manager?'
#keyword = 'relating'
#keyword = 'label queue'
#keyword = 'viewing pending delivery requests'
#keyword = 'file part'
keyword = 'generating a report'
...
p = pdfdoc.load_page(pagel[0]) #Throws exception page not in document and page shows as 81 and pdfdoc shows as having 81 pages
text = p.get_text()
