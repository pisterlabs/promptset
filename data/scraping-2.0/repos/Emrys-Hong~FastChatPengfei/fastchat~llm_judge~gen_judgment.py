...
if __name__ == "__main__":
    ...
    if args.mode == "single":
        ...
        output_file = (
            f"data/{args.bench_name}/model_judgment/{args.model_list[0]}_single.jsonl"
        )
    ...
    print("Stats:")
    #print(json.dumps(match_stat, ensure_ascii=False, indent=4))
    print(json.dumps(match_stat))
