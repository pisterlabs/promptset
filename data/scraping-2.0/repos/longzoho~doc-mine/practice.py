...
def load_document():
    ...
    document.metadata = {**document.metadata, "title": "Electronic Signatures"}
...
def query_document():
    ...
    kwargs = {
        ...
        "n_batch": 128 if device_type.lower() == "cuda" else None,
        "f16_kv": True,
        "verbose": False
    }
    ...
    result = retrievalQA(
        "What are services that can be used to create an eCommerce system?")
