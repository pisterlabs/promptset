...
class CustomPythonAstREPLTool(BaseTool):
    ...
    description = (
        ...
        "IMPORTANT: If you want to see the output of a value, you should print it out with `print(...)`."
        "For example if you want to see the value of `df.corr()`, you should use `print(df.corr())`."
    )
