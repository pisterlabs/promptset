...
result_single_write_file = "./results/mgkg_result/paragraph_pubmed_0720_retry_result_single.json"
retry_write_file = "./data/mgkg_data/paragraph_pubmed_0720_retry_retry.txt"
with open(paragraph_file, "r") as file:
    paragraphs = file.readlines()
paragraphs = paragraphs[0: len(paragraphs)//2]  # 只处理前半部分paragraph
