...
def create_sections(filename, page_map, use_vectors):
    ...
    for i, (content, pagenum) in enumerate(split_text(page_map)):
        section = {
            "id": f"{file_id}-page-{i}",
            "content": content,
            "managementfees": "Management fees: 549.3 million in 2022, 926.7 million in 2021",
            "performancefees": "Performance fees: 0.9 million in 2022, 200.5 million in 2021",
            "frontendfees": "Front-end fees: 34.3 million in 2022, 154.4 million in 2021",
            "managementfeerebate": "Management fee rebate: 218.7 million in 2022, 370.4 million in 2021",
            "performancefeerebate": "Performance fee rebate: - in 2022, 1.5 million in 2021",
            "otherrevenuerebate": "Other revenue rebate: 33.9 million in 2022, 154.3 million in 2021",
            "otherincome": "Other income: 76.7 million in 2022, 125.6 million in 2021",
    ...
    if args.index not in index_client.list_index_names():
        index = SearchIndex(
            ...
            fields=[
                ...
                SearchableField(name="managementfees", type="Edm.String", analyzer_name="en.microsoft"),
                SearchableField(name="performancefees", type="Edm.String", analyzer_name="en.microsoft"),
                SearchableField(name="frontendfees", type="Edm.String", analyzer_name="en.microsoft"),
                SearchableField(name="managementfeerebate", type="Edm.String", analyzer_name="en.microsoft"),
                SearchableField(name="performancefeerebate", type="Edm.String", analyzer_name="en.microsoft"),
                SearchableField(name="otherrevenuerebate", type="Edm.String", analyzer_name="en.microsoft"),
                SearchableField(name="otherincome", type="Edm.String", analyzer_name="en.microsoft"),
