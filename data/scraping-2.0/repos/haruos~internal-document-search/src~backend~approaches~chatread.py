...
class ChatReadApproach(Approach):
    def __init__(self, container_log: ContainerProxy):
    ...
    async def run(self, user_name: str, history: list[dict[str, str]], overrides: dict[str, Any]) -> Any:
        ...
        await write_chatlog(self.container_log, ApproachType.Chat, user_name, total_tokens, input_text, response_text)
