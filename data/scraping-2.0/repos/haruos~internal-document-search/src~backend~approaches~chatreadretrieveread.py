...
"""
    ...
    def __init__(self, search_client: SearchClient, container_log: ContainerProxy, embedding_deployment: str, sourcepage_field: str, content_field: str):
    ...
    async def run(self, user_name: str, history: list[dict], overrides: dict) -> any:
