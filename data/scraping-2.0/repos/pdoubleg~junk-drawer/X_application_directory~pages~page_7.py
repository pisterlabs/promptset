...
st.write(
    "This sandbox is powered by :statue_of_liberty:**GPT**, 🦜[LangChain](https://langchain-langchain.vercel.app/docs/get_started/introduction.html) and :llama:[Llama-Index](https://gpt-index.readthedocs.io/en/latest/index.html)",
...
tools = [
    Tool(
        ...
        func=lambda q: str(
            ho3_index.as_query_engine(similarity_top_k=10, streaming=False).query(q)
        ),
    ...
    Tool(
        ...
        func=lambda q: str(
            doi_index.as_query_engine(similarity_top_k=10, streaming=False).query(q)
        ),
    ...
    Tool(
        ...
        func=lambda q: str(
            bldg_code_index.as_query_engine(similarity_top_k=10, streaming=False).query(
                q
            )
        ),
