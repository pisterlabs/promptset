...
from rllab.envs.grid_world_env_modified import GridWorldEnv
...
supported_gym_envs = ["MountainCarContinuous-v0", "InvertedPendulum-v1", "InvertedDoublePendulum-v1"]

other_env_class_map  = { "Cartpole" :  CartpoleEnv, "GridWorld" : GridWorldEnv}
