...
print(f'Getting model coherence for {twitter_model_path}', flush=True)
...
for coherence_measure in coherence_measures:
    ...
    print(f'{coherence_measure} score: {coherence_lda} - time elapsed: {time.time() - cT} seconds', flush=True)
