...
hr_data_path = os.path.join(root, 'data', 'hr', 'policy')


loader = DirectoryLoader(hr_data_path, glob='./*.pdf', loader_cls=PyPDFLoader)
...
collection = client.create_collection("accio_hr_llama")
