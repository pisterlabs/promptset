...
for i in range(1, num+1):
    ...
    response = openai.ChatCompletion.create(
        model="gpt-3.5-turbo",
        messages=[
            {"role": "user", "content": f"write a motivation line of or on {cop.upper()}  in hindi without any  translation, dont use : {news}  just write a motivation line from great person"}
        ]
    )
    ...
    font = ImageFont.truetype('TiroDevanagariHindi-Regular.ttf', size=23)
