...
import quasar.model_patcher as quasar_model_patcher
from quasar.model_patcher import ModelPatcher
import quasar.model_management as model_management
from quasar.utils import calculate_parameters, load_torch_file
from quasar.ldm.modules.diffusionmodules.openaimodel import ResBlock, SpatialTransformer
...
orig_modelpatcher_clone = quasar_model_patcher.ModelPatcher.clone
def clone_injection(self, *args, **kwargs):
    ...
    return model
quasar_model_patcher.ModelPatcher.clone = clone_injection
