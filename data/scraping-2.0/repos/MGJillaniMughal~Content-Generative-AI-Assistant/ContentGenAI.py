...
def generate_content(openai_api_key, text, content ,thread:bool=False):
    ...
    # Using a dictionary for mapping content types to their respective generators
    content_map = {
        "Summary": summary_generator,
        "Blog": blog_generator,
        "Tweet": lambda: tweet_generator(thread=thread),
        "Newsletter": newsletter_generator
    }
    
    # Fetching the appropriate prompt based on content type
    prompt = content_map.get(content, lambda: None)()
...
def main():
    ...
    st.sidebar.markdown("<h3 style='text-align: center;'>Welcome to ContentGen AI Assisstant by Jillani Soft Tech</h3>", unsafe_allow_html=True)
...
#    st.sidebar.image("https://user-images.githubusercontent.com/76085202/213906302-0a9419cc-f4c9-4bff-b4be-983511323580.gif", width=300)
    ...
    # Content Categories
    categories = ["General", "Tech", "Lifestyle", "Business", "Health", "Entertainment"]
    selected_category = st.sidebar.selectbox("Select Content Category", categories)

 
#    st.header("Content Creator by Jillani Soft Tech")

    st.markdown("<h2 style='text-align: center;'> 😎 Content Creator by Jillani Soft Tech 😎</h2>", unsafe_allow_html=True)
    ...
    st.sidebar.markdown("""[![Follow](https://img.shields.io/badge/LinkedIn-0A66C2.svg?style=for-the-badge&logo=LinkedIn&logoColor=white)](https://www.linkedin.com/in/jillanisofttech/)
                        [![Follow](https://img.shields.io/badge/GitHub-181717.svg?style=for-the-badge&logo=GitHub&logoColor=white)](https://github.com/MGJillaniMughal)""")
