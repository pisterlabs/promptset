...
def main(num):
    ...
    model_stuff = data.load_checkpoint("/nas/home/yufei/hyperbole_gen/comet-dataset/models/conceptnet-generation/iteration-5000-100000/transformer/rel_language-trainsize_100-devversion_12-maxe1_10-maxe2_15-maxr_5/model_transformer-nL_12-nH_12-hSize_768-edpt_0.1-adpt_0.1-rdpt_0.1-odpt_0.1-pt_gpt-afn_gelu-init_pt-vSize_40543/exp_generation-seed_123-l2_0.01-vl2_T-lrsched_warmup_linear-lrwarm_0.002-clip_1-loss_nll-b2_0.999-b1_0.9-e_1e-08/bs_1-smax_40-sample_greedy-numseq_1-gs_full-es_full/1e-05_adam_32_20000.pickle")
    
    model = models.make_model(
        opt, n_vocab, n_ctx, n_special,
        load=(opt.net.init=="pt"))
    #model.load_state_dict(torch.load("/nas/home/yufei/hyperbole_gen/comet-dataset/models/conceptnet-generation/iteration-5000-100000/transformer/rel_language-trainsize_100-devversion_12-maxe1_10-maxe2_15-maxr_5/model_transformer-nL_12-nH_12-hSize_768-edpt_0.1-adpt_0.1-rdpt_0.1-odpt_0.1-pt_gpt-afn_gelu-init_pt-vSize_40543/exp_generation-seed_123-l2_0.01-vl2_T-lrsched_warmup_linear-lrwarm_0.002-clip_1-loss_nll-b2_0.999-b1_0.9-e_1e-08/bs_1-smax_40-sample_greedy-numseq_1-gs_full-es_full/1e-05_adam_32_20000.pickle"))
    models.load_state_dict(model, model_stuff["state_dict"])
    print("Done.")
    print("loaded trained file")
