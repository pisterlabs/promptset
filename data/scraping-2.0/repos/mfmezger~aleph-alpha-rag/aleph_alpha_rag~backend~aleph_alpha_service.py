...
def embedd_documents(dir: str, aleph_alpha_token: str, collection_name: Optional[str] = None) -> None:
...
def process_documents(folder: str, token: str, type: str) -> List[str]:
...
if __name__ == "__main__":
    ...
    qa_chain("What is Attention", token, "aleph_alpha")
