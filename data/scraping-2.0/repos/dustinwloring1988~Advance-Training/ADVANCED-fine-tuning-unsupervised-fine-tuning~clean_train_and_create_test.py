...
with open("data/train.txt", "w", encoding='utf-8') as train_file, \
    ...
    for snippet in [
        "Clean up the above information and respond with the complete text. Avoid using special characters. Keep formatting very simple and suitable for a .txt file. Do not respond in markdown.",
        "Select and re-phrase ten key takeaways from the above text without changing their meaning. Respond in plain text. Leave out any numbers or bullets."
    ]:
