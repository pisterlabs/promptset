...
class RobotGazeboEnv(gym.Env):
    ...
    def __init__(self, robot_name_space, controllers_list, reset_controls, start_init_physics_parameters=True, reset_world_or_sim="SIMULATION"):
        ...
        self.cumulated_tom_episode_reward = 0

        self.cumulated_jerry_episode_reward = 0
    ...
    def step(self, action):
        ...
        info = {}
        tom_reward, jerry_reward = self._compute_reward(obs, done)
        print("TOM_REWARD_TIME_STEP", tom_reward)
        print("JERRY_REWARD_TIME_STEP" , jerry_reward)
        self.cumulated_episode_reward +=tom_reward
        self.cumulated_episode_reward += jerry_reward
        
        return obs, tom_reward + jerry_reward, done, info
