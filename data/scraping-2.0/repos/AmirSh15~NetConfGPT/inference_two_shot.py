...
# Load the model
model_id = "bigcode/starcoderbase-1b" # "mistralai/Mistral-7B-Instruct-v0.1" # "mistralai/Mistral-7B-v0.1" # "bigcode/starcoderbase-1b" # "Salesforce/codegen25-7b-multi" # "cerebras/btlm-3b-8k-base" # "meta-llama/Llama-2-70b-chat-hf" # "tiiuae/falcon-40b"
...
with open(yang_file_path, "r") as f:
    yang_file_1 = f.read()
yang_file_1 = remove_descriptions(yang_file_1)

file_name = "group_profiles"
# read xml file
xml_file_path = f"/home/amir/NetConfGPT/examples/{file_name}.xml"
with open(xml_file_path, "r") as f:
    xml_file_2 = f.read()
...
with open(yang_file_path, "r") as f:
    yang_file_2 = f.read()
yang_file_2 = remove_descriptions(yang_file_2)
...
XML:
"""
prompt = PromptTemplate(template=template, input_variables=["yang_1", "xml_1", "yang_2", "xml_2", "yang_test"])
prompt_len = tokenizer.encode(prompt.format_prompt(yang_1=yang_file_1, xml_1=xml_file_1, yang_2=yang_file_2, xml_2=xml_file_2, yang_test=yang_file_test).text, return_tensors="pt").shape[1]
...
# output_lc = chain.invoke({"yang_1": yang_file_1, "xml_1": xml_file_1, "yang_2": yang_file_2, "xml_2": xml_file_2, "yang_test": yang_file_test})
# end_time = time.time()
...
# inference model
prompt = prompt.format_prompt(yang_1=yang_file_1, xml_1=xml_file_1, yang_2=yang_file_2, xml_2=xml_file_2, yang_test=yang_file_test).text
