...
Thought: {agent_scratchpad}"""    
    ...
    CognitiveSearchToolDescription = "useful for searching NetApp Product information such as Product questions, technical questions, etc."
...
class EmployeeInfoTool(CsvLookupTool):
    ...
    def __init__(self, employee_name: str):
        super().__init__(filename = "data/employeeinfo.csv", key_field = "name", name = "Employee", description = "useful for searching NetApp Product information such as Product questions, technical questions, etc.")
