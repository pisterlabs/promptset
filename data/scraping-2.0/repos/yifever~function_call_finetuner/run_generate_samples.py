...
if __name__ == "__main__":
    ...
    for function in data:
        ...
        if function_desc is None:
            raise KeyError(f"Function data in {input_file_name} should have field 'description'")

        messages, output, meta = generate_data_sample_from(function_desc, model, temperature)
