...
front_matter_translation_rules = {
    ...
    # 使用固定的替换规则
    "category": lambda value, lang: front_matter_replace(value, lang),
    "tag": lambda value, lang: front_matter_replace(value, lang),
...
ignore_patterns = [re.compile(r'```.*?```', re.S|re.M)]
