...
# you need to create a repo issue and get the issue number
...
def make_pic_and_save(sentence):
    ...
    image_url_for_issue = f"https://github.com/yangchuang/yangchuang.github.io/blob/master/OUT_DIR/{date_str}/{index}.jpeg?raw=true"
