...
if __name__ == '__main__':
    ...
    vocab_file = GPT_CONUT_TRAINER_DIR + '../../data/data/js/vocabulary.txt'
    train_file = GPT_CONUT_TRAINER_DIR + '../../data/data/js/training_bpe.txt'
    valid_file = GPT_CONUT_TRAINER_DIR + '../../data/data/js/validation_bpe.txt'
