...
Persona = os.path.join('persona', 'Ellie_v1.1.md')
...
portrait = os.path.join('Portrait', 'Ellie.png')
verbose_chatlog = os.path.join('v_chatlog', 'all_messages.txt')

st.markdown("<h1 style='text-align: center;'>Ellie</h1>", unsafe_allow_html=True)
