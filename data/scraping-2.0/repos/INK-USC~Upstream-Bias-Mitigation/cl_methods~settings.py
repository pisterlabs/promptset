...
def parse_args():
    ...
    args.model_dir_root = os.path.join(args.output_dir, args.model_name,
    ...
    args.device_ids = [0]#GPUtil.getAvailable(limit=args.n_gpus)
    ...
    #args.n_train_epochs = args.num_train_epochs
    return args
