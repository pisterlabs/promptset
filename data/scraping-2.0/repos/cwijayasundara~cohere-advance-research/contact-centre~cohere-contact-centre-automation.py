...
st.set_page_config(page_title="Contact Centre Automation for ABC Plc", layout="wide",
                   initial_sidebar_state="collapsed", page_icon="/Users/chamindawijayasundara/Documents/self_learn"
                                                                "/cohere-advanced-research/contact-centre/robo.png")

icon = Image.open("/Users/chamindawijayasundara/Documents/self_learn"
                  "/cohere-advanced-research/contact-centre/robo.png")
