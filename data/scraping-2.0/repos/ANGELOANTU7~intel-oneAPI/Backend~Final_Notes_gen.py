...
async def summarize_file(bucket_name: str, file_key: str, file_name:str):
    try:
        ...
        prompt = f'You are a teacher , make a full explaination for the topic:{file_name} below in good format. Include key concepts, explanations, and any relevant information. \n make sure to cover these topics :\n{file_content}'
