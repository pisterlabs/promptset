...
class Agent(SACAgent):
    ...
    def update_model(self, experiences):
        ...
        with torch.autograd.set_detect_anomaly(True):
            ...
            simple_states, actions, rewards, next_simple_states, dones, weights = self.np2torchTensor(
                [simple_states, actions, rewards, next_simple_states, dones, weights])
            ...
            if self.use_n_step:
                ...
                simple_states, rewards, next_simple_states, dones = self.np2torchTensor(
                    [simple_states, rewards, next_simple_states, dones])
    ...
    def train(self):
        ...
        if self.args.log:
            ...
            wandb.watch([self.actor, self.vf, self.qf_1, self.qf_2, self.explainer], log="parameters")
