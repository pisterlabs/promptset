...
def question_generation_input(data_item, TOKEN_MAXLEN, example_set):
...
if __name__=="__main__":
    ...
    parse.add_argument('--sample_num', type=int, default=9)
    ...
    # parse.add_argument('--with_hint', action='store_true')
    for ditem in dataset[4:args.sample_num]:
        ...
        while chance_count < args.chance_num:
            ...
            if chance_count == 0:
                question_generation_prompt = question_generation_input(ditem,TOKEN_MAXLEN=args.token_maxlen, example_set=TRUE)
            else:
                question_generation_prompt = question_generation_input(ditem,TOKEN_MAXLEN=args.token_maxlen,example_set=FALSE)
