...
from annotated_demos.mannual_pot.code_executor import run_code
from annotated_demos.mannual_pot.core.runtime import GenericRuntime
...
def get_gpt3_output(prompt, patience,label = None):
    ...
    while True:
        ...
        try:
            ...
            for idx, r in enumerate(codes):
                r = "def solution():\n"+r.str
                ans = run_code(runtime = runtime,code_gen=r, answer_expr="solution()")
                # ans = safe_execute(r)
