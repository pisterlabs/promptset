'''
Car dynamics taken from OpenAI gym
'''
import numpy as np
import math
...
FRICTION_LIMIT = 1000000*SIZE*SIZE  # OG
WHEEL_R = 27
WHEEL_W = 14
# WHEEL_W = 27
WHEELPOS = [
...
class Car:
    def __init__(self, world, init_angle, init_x, init_y, grass_friction=None):
        # Box2D WORLD
        self.world = world
        # Friction of grass (defined as a ratio to the road friction)
        ...
        for wx, wy in WHEELPOS:
            ...
            # First two wheels are front wheels, and the next two are rear
            # Create wheel bodies
    ...
    def step(self, dt):
        for w in self.wheels:
            ...
            grass = True
            if self.grass_friction is None:
                friction_limit = FRICTION_LIMIT*0.6  # Grass friction if no tile
            else:
                friction_limit = FRICTION_LIMIT*self.grass_friction
            for tile in w.tiles:
                friction_limit = max(
