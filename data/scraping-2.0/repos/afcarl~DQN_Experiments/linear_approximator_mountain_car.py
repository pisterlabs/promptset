...
def q_learning(env, estimator, num_episodes, discount_factor=1.0, epsilon=0.1, epsilon_decay=1.0):
	...
	for i_episode in range(num_episodes):
		print "Episode Number, Linear Mountain Car:", i_episode
...
def save_cum_rwd(stats, smoothing_window=1, noshow=False):
    ...
    np.save('/Users/Riashat/Documents/PhD_Research/BASIC_ALGORITHMS/My_Implementations/gym_examples/DQN_Experiments/'  + 'linear_approx_mountain_car_cumulative_reward' + '.npy', cum_rwd)
	...
	# np.save('/Users/Riashat/Documents/PhD_Research/BASIC_ALGORITHMS/My_Implementations/gym_examples/DQN_Experiments/'  + 'linear_approx_acrobat_cumulative_reward' + '.npy', cum_rwd)
