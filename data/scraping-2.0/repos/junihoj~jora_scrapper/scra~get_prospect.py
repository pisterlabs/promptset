...
employee_job_titles = [employee_data['title'] for employee_data in sample_prospect if employee_data['title'] is not None]
print("EMPLYOEED JOB TITLES", employee_job_titles)
...
selected_prospect = [k for k in sample_prospect if k['title'] in matched]
