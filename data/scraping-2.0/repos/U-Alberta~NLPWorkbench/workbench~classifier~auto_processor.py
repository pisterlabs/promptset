...
class AutoProcessor(object):
    ...
    def __init__(self, pretrained_model_name_or_path, do_lower_case):
        self.tokenizer = AutoTokenizer.from_pretrained(
            pretrained_model_name_or_path, do_lower_case=do_lower_case
        )
        if pretrained_model_name_or_path == "openai-gpt":
            self.tokenizer.pad_token = OpenAIGPTTokenizer.eos_token
