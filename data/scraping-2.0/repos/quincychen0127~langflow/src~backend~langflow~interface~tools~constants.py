...
from langflow.interface.tools.custom import PythonFunctionTool, PythonFunction, GetMarketingObjectives, GetCustomerPocAPI, OptOutCheckupToolAPI, ReportingAPI, GetTopPitchableCustomer, EmailAPI, FetchNextBestAction, GetAdsReportingData, PlannerAgent, SalesOutreachAgent, SalesContextAgent, AdwordsPerformanceAgent
...
CUSTOM_TOOLS = {
    ...
    "SalesOutreachAgent": SalesOutreachAgent,
    "SalesContextAgent": SalesContextAgent,
    "AdwordsPerformanceAgent": AdwordsPerformanceAgent,
}
