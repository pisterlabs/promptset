...
def search(query):
    ...
    headers = {
        "X-API-KEY": "250d45404c0213c6d206c0caae3a5f9f9ae62f85",
...
def research(query):
    ...
    # set the researcher to be the receiver and get a summary of the research report
...
user_proxy.initiate_chat(
    writing_assistant,
    message="write a blog about the recent war between Isreal and Hamas",
)
