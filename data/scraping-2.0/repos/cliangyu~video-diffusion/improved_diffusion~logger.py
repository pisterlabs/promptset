...
def logkv(key, val):
    """Log a value of some diagnostic Call this once for each diagnostic
    quantity, each iteration If called many times, last value will be used."""
...
def log(*args, level=INFO):
    """Write the sequence of args, with no separators, to the console and
    output files (if you've configured an output file)."""
...
def configure(dir=None,
    ...
    output_formats = [
        make_output_format(f,
                           dir,
                           log_suffix,
                           config=config,
                           wandb_kwargs=wandb_kwargs) for f in format_strs
    ]
