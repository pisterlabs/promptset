...
async def main():
    ...
    attractions = prompts['attractions_multiple_variables']

    input_context=kernel.create_new_context()
    input_context["city"] = "New York City"
    input_context["n_days"] = "3"
    input_context["likes"] = "restaurants, Ghostbusters, Friends tv show"
    input_context["dislikes"] = "museums, parks"
    input_context["n_attractions"] = "5"
