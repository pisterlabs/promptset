...
parser = argparse.ArgumentParser(description='Create nine images from text prompt.')
parser.add_argument(
    'prompt',
    metavar='PROMPT',
    type=str,
    default="Photorealistic landscape painting of a mountain lake with a boat in the foreground",
