...
wandb_project = 'owt'
wandb_run_name = 'SkyGPT_yt' # 'run' + str(time.time())
# data
dataset = 'whispering'
...
n_head = 8
n_embd = 512
dropout = 0.0001 # for pretraining 0 is good, for finetuning try 0.1+
...
min_lr = 0.00008 # minimum learning rate, should be ~= learning_rate/10 per Chinchilla
# DDP settings
...
while True:
    ...
    dt = t1 - t0
    t0 = t1
    if iter_num % log_interval == 0 and master_process and not iter_num % eval_interval == 0:
