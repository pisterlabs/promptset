...
def generate_traces(num_cores, period, access_size, outdir):
    ...
    for i in range(num_cores):
        if i != 0:
            ...
            state_lines = [
                f"STATE 0 0 LINEAR 100 0 65536 64 500 500 65536\n",
                f"STATE 1 100000000 IDLE\n",
                f"STATE 2 0 EXIT\n",
                f"STATE 3 0 LINEAR 100 0 65536 {access_size} {period} {period} 2097152\n",
                f"STATE 4 0 EXIT\n",
...
@novoverse
def run_l1_bandwidth_test(inputs):
    import m5
    ...
    while True:
        ...
        if exit_events_countered == 1:
            print("Done warming up l1.")
            m5.stats.reset()
        if exit_events_countered == 2:
            print("Done stressing l1")
            break
...
if __name__ == "__m5_main__":
    run_l1_bandwidth_test(get_inputs())
