...
class Anti_Suicide_Bot:
    def __init__(self):
        self.conversation_history_agent = "YOU ARE DEALING WITH A SENSITIVE KID WHAT WAS TRYING TO COMMIT SUICIDE, BE GENTLE, TRY TO CALM HIM DOWN  INPUT: {user_input} . OUTPUT:"
