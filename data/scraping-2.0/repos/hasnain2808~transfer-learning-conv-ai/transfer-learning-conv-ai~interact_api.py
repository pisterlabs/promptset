...
def sample_sequence(personality, history, tokenizer, model, args, current_output=None):
    ...
    for i in range(args.max_length):
        instance = build_input_from_segments(personality, history[-(2*args.max_history+1):], current_output, tokenizer,f_history = history[:-(2*args.max_history+1)] , with_eos=False)
...
class Args:
    ...
    model = 'gpt'
    model_checkpoint = 'runs/Mar20_06-32-27_ip-172-31-67-62_openai-gpt/'
    max_history = 2
...
@app.route('/nextDialogue', methods=['GET'])
def nextDialogue():
    global history
    raw_text = 'placeholderRaw'
