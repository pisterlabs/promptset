...
supported_gym_envs = ["MountainCarContinuous-v0", "Hopper-v1", "InvertedPendulum-v1", "Walker2d-v1", "Humanoid-v1", "Reacher-v1", "HalfCheetah-v1", "Swimmer-v1", "HumanoidStandup-v1"]
...
for r in range(len(reward_scaling)): 
    ...
    for e in range(num_experiments):
        ...
        run_experiment_lite(
            ...
            # will be used
            exp_name="reproducibility_ML/" + "DDPG/" + "InvertedPendulum/" + "Reward_Scale_Tune/" +  "Reward_Scale_" + str(reward_scaling[r]) + "_Experiment_" + str(e),
            seed=1,
            plot=args.plot,
        )
