...
def behavioural_cloning_train(data_dir, in_model, in_weights, out_weights):
    ...
    for batch_i, (batch_images, batch_actions, batch_episode_id) in enumerate(data_loader):
        ...
        for image, action, episode_id in zip(batch_images, batch_actions, batch_episode_id):
            ...
            print("agent_action: ", agent_action)
            #print("unsqueeze: ", tree_map(lambda x: x.unsqueeze(1), action))
            print("vs")
            print("pi_distribution: ", pi_distribution)

            print("original_pi_distribution: ", original_pi_distribution)
            #time.sleep(1000)
            ...
            print("kl_div: ", kl_div)
            #kl_div = th.tensor([[[0.0004]]], device='cuda:0') #, grad_fn=<AddBackward0>
            #print("kl_div: ", kl_div)
            ...
            print("loss: ", loss)
            #loss = th.tensor([[[1.1168]]], device='cuda:0')
            loss_sum += loss.item()
