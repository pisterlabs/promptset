...
class DALLE(nn.Module):
    ...
    def forward(
        ...
        ## RuntimeError: expected scalar type long int but found float (21.5.16)
#         text_range = text_range.to(device)
        
#         print(f"*************** text type : {text}, text_range : {text_range}")
        
        text = text.type(torch.cuda.LongTensor)
