...
class Application(tk.Frame):
    def __init__(self, master=None):
        ...
        self.voice_map = {voice['ShortName']: voice['DisplayName'] for voice in voice_data}
    ...
    def create_widgets(self):
        ...
        self.voice_selector = tk.OptionMenu(self, self.current_voice, *self.voice_map.values())
    ...
    def main(self):
        ...
        speech_config.speech_synthesis_voice_name = self.current_voice.get()
        ...
        while self.is_running:
            ...
            response_text = generate_response(input_text, self.conversation_history, self.model_choice.get())
