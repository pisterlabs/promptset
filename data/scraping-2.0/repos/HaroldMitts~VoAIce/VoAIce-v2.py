# VoAIce.py version: 2.0
# May 18, 2023
# improvements include 
# UI, ability to save the conversation history, ability to change the voice, 
# ability to change the GPT model, temperature, and max_tokens.
# This script assumes you have the voices.json file in the same directory as this script.
