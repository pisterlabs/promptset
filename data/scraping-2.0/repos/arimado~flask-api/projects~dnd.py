...
class DialogueSimulator:
    ...
    def step(self) -> tuple[str, str]:
        ...
        for reciever in self.agents:
            reciever.receive(speaker.name, message)
...
# Generate Prompts
character_names = ["Tony Soprano", "Kanye West", "Harry Potter"]
storyteller_name = "Dungeon Master"
quest = "Find all of Lord Voldemort's seven horcruxes."
word_limit = 50  # word limit for task brainstorming

game_description = f"""Here is the topic for a role playing game: {quest}.
        The characters are: {*character_names,}.
        The story is narrated by the storyteller, {storyteller_name}."""

player_descriptor_system_message = SystemMessage(
    content="You can add detail to the description of each character."
)
