...
class App:
    def __init__(self, story, characters, story_image):
        ...
        # Button to predict next action event based on chosen personality for the selected character
        # self.btn1=ttk.Button(self.window, text="   DETERMINE NEXT ACTION EVENT   ", command=self.getUIDataAndChooseAction)
