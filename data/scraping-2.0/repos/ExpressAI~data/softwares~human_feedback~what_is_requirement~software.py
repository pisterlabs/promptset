...
INSTRUCTION = (
    "I developed an AI chatbot that searches the Internet for relevant"
    " documents to answer the user's questions. While chatting with my"
    " bot, the user can see the query my bot used to search the Internet"
    " and can make suggestions about this query. Please summarize in up"
    " to 6 words the requirements for a good search query that the user"
    " expects."
)
