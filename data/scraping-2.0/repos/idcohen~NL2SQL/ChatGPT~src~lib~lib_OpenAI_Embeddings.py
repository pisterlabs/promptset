...
from ChatGPT.src.lib.OpenAI_Func import Num_Tokens_From_String, OpenAI_Embeddings_Cost, OpenAI_Embeddings_Cost
...
class VDS(OpenAI_Embeddings):
    ...
    def Load_VDS_DF(self, sep='|', Sheetname = 'VDS', Verbose=False):
...
# Insert row into Embeddings DF
    ...
    def Search_VDS(self, Question, Similarity_Func = 'Cosine', Top_n=1) \
