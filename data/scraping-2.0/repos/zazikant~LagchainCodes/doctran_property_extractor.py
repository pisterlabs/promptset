...
abc = documents.__str__()

#it is recommened to pass whole document to doctran property extractor instead of splitted chunks.else the extraction would happen only on the splitted chunk and not on the whole document
...
documents = [Document(page_content= abc)]
...
properties = [
    {
        ...
        "type": "string",
        "enum": ["football", "dental", "food", "cricket", "other"],
        "required": True,
    },
    {
        "name": "keywords",
        "description": "pick up keywords from the document related from SEO standpoint",
        "type": "string",
        "required": True,
    },
]
