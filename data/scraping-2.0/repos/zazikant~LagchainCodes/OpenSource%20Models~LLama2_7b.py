...
tokenizer = AutoTokenizer.from_pretrained("NousResearch/Llama-2-7b-chat-hf") #nousresearch is exactly the same as meta lama, it does not require authentication
