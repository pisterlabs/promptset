"""
MADDPG from RLLIB. I used the fix described in https://github.com/ray-project/ray/issues/9651 to fix the bug that is also describe there
    ...
    samples.update(
        {
            ...
            for i, new_act in zip(policies_to_train, new_act_n)
        }
    )
