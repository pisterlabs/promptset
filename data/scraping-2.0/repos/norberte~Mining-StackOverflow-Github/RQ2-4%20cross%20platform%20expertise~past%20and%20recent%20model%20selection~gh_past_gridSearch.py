...
logging.basicConfig(filename='/home/norberteke/PycharmProjects/Thesis/logs/GH_past_grid_search_3000.log',
                    format='%(asctime)s : %(levelname)s : %(message)s', level=logging.INFO)
config_path = "/home/norberteke/PycharmProjects/Thesis/data/GH_past_grid_search_config_log.csv"
...
for topic in topic_num:
    ...
    for b in beta:
        ...
        temp_file = datapath("/home/norberteke/PycharmProjects/Thesis/grid_search_models/GH_past/topic_" +
                             str(topic) + "_beta_" + str(b) + ".lda")
        lda.save(temp_file)
        #np.savetxt("/home/norberteke/PycharmProjects/Thesis/grid_search_models/GH_past/topic_" +
