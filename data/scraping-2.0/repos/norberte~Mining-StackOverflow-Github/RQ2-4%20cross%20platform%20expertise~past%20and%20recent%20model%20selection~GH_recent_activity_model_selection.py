...
logging.basicConfig(filename='/home/norberteke/PycharmProjects/Thesis/logs/GH_recent_activity_optimizer_10000.log', format='%(asctime)s : %(levelname)s : %(message)s', level=logging.INFO)
config_path = "/home/norberteke/PycharmProjects/Thesis/data/GH_recent_model_parameter_configs.csv"
runs = 9990
...
dictionary.save("/home/norberteke/PycharmProjects/Thesis/data/GH_recent_full_activity_gensimDictionary.dict")

with open("/home/norberteke/PycharmProjects/Thesis/data/GH_recent_full_activity_corpus.txt", 'w') as f:
    for text in texts:
        f.write(str(text) + "\n")
...
checkpoint_saver = CheckpointSaver("/home/norberteke/PycharmProjects/Thesis/data/GH_recent_param_optimizer_checkpoint.pkl")


#res = load('/home/norberteke/PycharmProjects/Thesis/data/GH_recent_param_optimizer_checkpoint.pkl')
#x0 = res.x_iters
#y0 = res.func_vals
...
try:
    dump(res_gp, '/home/norberteke/PycharmProjects/Thesis/data/GH_recent_param_optimizer_result_10.pkl')
except:
    dump(res_gp,
             '/home/norberteke/PycharmProjects/Thesis/data/GH_recent_param_optimizer_result_without_objective_10.pkl', store_objective=False)
finally:
    try:
