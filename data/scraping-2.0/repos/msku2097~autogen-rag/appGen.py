#Reference to doc https://github.com/microsoft/autogen.git
#to run just put you OPENAI_API_KEY and launch from cmd panel serve --show appGenRag.py --address 0.0.0.0 --port 8080    
...
gpt4_config = {"config_list": config_list, "temperature":0.2, "seed": 57}
