...
st.markdown("<h1 style='color: #3B444B; font-style: italic; font-family: Comic Sans MS; font-size:4rem' >Healthy Wealthy Doubt Solver 🤔</h1> <h3 style='color:#54626F; font-style: italic; font-family: Comic Sans MS; font-size:2rem'>Unlocking Health & Wealth: Your Doubt Solver for a Happy, Healthy Life!</h3>", unsafe_allow_html=True)
