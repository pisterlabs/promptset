...
class ConversableAgent(Agent):
    ...
    def _print_received_message(self, message: Union[Dict, str], sender: Agent):
        ...
        if message.get("role") == "function":
            ...
            storeConversationMessage(sender.name, self.name, "Research Process", 0, f"FUNCTION CALL ({message['name']}): {func_print} \n\n{message['content']}")
            ...
            if content is not None:
                ...
                storeConversationMessage(sender.name, self.name, "Research Process", 0, content)
            ...
            if "function_call" in message:
                ...
                storeConversationMessage(sender.name, self.name, "Research process", 0,
                                         f"\n{func_print}\nArguements: {function_call.get('arguments', '(No arguments found)')}")
