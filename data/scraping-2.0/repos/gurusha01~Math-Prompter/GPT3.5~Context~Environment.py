...
class Reward:
    ...
    def generate(self, input_prompt):
        ...
        2. Answer should be a numerical value only.
        3. Final answer should be reported inside brackets example [[Answer: 33]].        
        '''
        #If Options are given in each question, The answer should be from the options "A", "B", "C", "D" or "E"
