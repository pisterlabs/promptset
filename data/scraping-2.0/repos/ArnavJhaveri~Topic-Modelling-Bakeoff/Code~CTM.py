...
for num_topics in num_topics_list:
  ...
  if logit:
    ...
    dummy_train = pd.get_dummies(labels, dtype=int)
    dummy_test = pd.get_dummies(test_labels, dtype=int)
    ...
    accuracies = [np.mean(accuracies), ctm_topic_diversity, ctm_coherence] + accuracies + [np.mean(r2s)]
