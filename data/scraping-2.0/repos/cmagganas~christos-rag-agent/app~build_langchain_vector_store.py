#!/usr/bin/env python3
"""
Builds and persists a LangChain vector store over the Weite documentation using Chroma.
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        default="/home/cmagganas/christos-rag-agent/pulze/langchain-chroma-pulze-docs",
    )
