...
from skllm.prompts.builders import (
    ...
    build_zero_shot_prompt_slc_mu_dim4,
    build_zero_shot_prompt_slc_sc_dim1,
    build_zero_shot_prompt_slc_sc_dim2,
    build_zero_shot_prompt_slc_sc_dim3,
    build_zero_shot_prompt_slc_sc_dim4,
    build_zero_shot_prompt_slc_ha_dim1,
    build_zero_shot_prompt_slc_ha_dim2,
    build_zero_shot_prompt_slc_ha_dim3,
    build_zero_shot_prompt_slc_ha_dim4,
)
...
class ZeroShotGPTClassifierScDimension1(_BaseZeroShotGPTClassifier):
    """Zero-shot classifier for multiclass classification.
    ...
    def _get_prompt(self, x) -> str:
        return build_zero_shot_prompt_slc_sc_dim1(x, repr(self.classes_))
...
class ZeroShotGPTClassifierScDimension2(_BaseZeroShotGPTClassifier):
    """Zero-shot classifier for multiclass classification.
    ...
    def _get_prompt(self, x) -> str:
        return build_zero_shot_prompt_slc_sc_dim2(x, repr(self.classes_))
...
class ZeroShotGPTClassifierScDimension3(_BaseZeroShotGPTClassifier):
    """Zero-shot classifier for multiclass classification.
    ...
    def _get_prompt(self, x) -> str:
        return build_zero_shot_prompt_slc_sc_dim3(x, repr(self.classes_))
...
class ZeroShotGPTClassifierScDimension4(_BaseZeroShotGPTClassifier):
    """Zero-shot classifier for multiclass classification.
    ...
    def _get_prompt(self, x) -> str:
        return build_zero_shot_prompt_slc_sc_dim4(x, repr(self.classes_))
...
class ZeroShotGPTClassifierMuDimension1(_BaseZeroShotGPTClassifier):
    """Zero-shot classifier for multiclass classification.
    ...
    def _get_prompt(self, x) -> str:
        return build_zero_shot_prompt_slc_mu_dim1(x, repr(self.classes_))
...
class ZeroShotGPTClassifierMuDimension2(_BaseZeroShotGPTClassifier):
    """Zero-shot classifier for multiclass classification.
    ...
    def _get_prompt(self, x) -> str:
        return build_zero_shot_prompt_slc_mu_dim2(x, repr(self.classes_))
...
class ZeroShotGPTClassifierMuDimension3(_BaseZeroShotGPTClassifier):
    """Zero-shot classifier for multiclass classification.
    ...
    def _get_prompt(self, x) -> str:
        return build_zero_shot_prompt_slc_mu_dim3(x, repr(self.classes_))
...
class ZeroShotGPTClassifierMuDimension4(_BaseZeroShotGPTClassifier):
    """Zero-shot classifier for multiclass classification.
    ...
    def _get_prompt(self, x) -> str:
        return build_zero_shot_prompt_slc_mu_dim4(x, repr(self.classes_))
...
class ZeroShotGPTClassifierHaDimension1(_BaseZeroShotGPTClassifier):
    """Zero-shot classifier for multiclass classification.
...
class ZeroShotGPTClassifierHaDimension2(_BaseZeroShotGPTClassifier):
    """Zero-shot classifier for multiclass classification.
...
class ZeroShotGPTClassifierHaDimension3(_BaseZeroShotGPTClassifier):
    """Zero-shot classifier for multiclass classification.
...
class ZeroShotGPTClassifierHaDimension4(_BaseZeroShotGPTClassifier):
    """Zero-shot classifier for multiclass classification.
