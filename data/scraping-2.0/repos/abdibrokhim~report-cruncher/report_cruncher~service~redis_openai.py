...
from report_cruncher.service.embadding_generator import get_embedding, SEPARATOR_LEN, SEPARATOR, get_completion
from report_cruncher.service.redis import init, search_redis
...
def construct_prompt(question: str, MAX_SECTION_LEN=None) -> str:
    """
