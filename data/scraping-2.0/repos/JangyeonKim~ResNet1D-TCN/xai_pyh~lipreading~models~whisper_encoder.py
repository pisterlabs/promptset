...
class OpenAIWhisperEncoder(AbsEncoder):
    ...
    def __init__(
        ...
        self.n_fft = N_FFT # 400
        self.win_length = N_FFT # 400
        self.hop_length = HOP_LENGTH # 160
        # self.hop_length = 320
        ...
        self.do_pad_trim = do_pad_trim # True or False
        self.pad_samples = N_SAMPLES # sec * sample_rate
