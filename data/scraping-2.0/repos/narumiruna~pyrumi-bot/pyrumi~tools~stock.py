...
class StockPriceTool(BaseTool):
    ...
    description = ("Useful for when you need to find out the price of stock. "
...
class StockPercentageChangeTool(BaseTool):
    ...
    description = ("Useful for when you need to find out the percentage change in a stock's value. "
                   "You should input the stock ticker used on the yfinance API "
...
class StockGetBestPerformingTool(BaseTool):
    ...
    description = ("Useful for when you need to the performance of multiple stocks over a period."
                   "You should input a list of stock tickers used on the yfinance API "
                   "and also input the number of days to check the change over.")
